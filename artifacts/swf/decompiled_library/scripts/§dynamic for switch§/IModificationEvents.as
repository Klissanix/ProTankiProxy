package §dynamic for switch§
{
   ...
   public class IModificationEvents implements §521423107332310746123423632234§
   {
      ...
      public function IModificationEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      public function getBaseItemId() : Long
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:§521423107332310746123423632234§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §521423107332310746123423632234§;
               _loc1_ = _loc3_.getBaseItemId();
               _loc2_++;
            }
         }
         finally
      ...
      public function getModificationIndex() : int
      {
         ...
         try
         {
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §521423107332310746123423632234§;
               _loc1_ = _loc3_.getModificationIndex();
               _loc2_++;
            }
         }
         finally
