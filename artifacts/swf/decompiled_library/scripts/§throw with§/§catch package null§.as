package §throw with§
{
   ...
   public class §catch package null§ implements §native catch continue§
   {
      ...
      public function §catch package null§(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
      ...
      public function §5214235875235888123423632234§() : Vector.<Long>
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:§native catch continue§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §native catch continue§;
               _loc1_ = _loc3_.§5214235875235888123423632234§();
               _loc2_++;
            }
         }
         finally
