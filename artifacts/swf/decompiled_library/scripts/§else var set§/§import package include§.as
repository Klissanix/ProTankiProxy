package §else var set§
{
   ...
   public class §import package include§ extends §extends package import§
   {
      
      public var §const const finally§:String;
      
      public function §import package include§(param1:String = "")
      {
         super();
      ...
      {
         return new §import package include§();
      }
