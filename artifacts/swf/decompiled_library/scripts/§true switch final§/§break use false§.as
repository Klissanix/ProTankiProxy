package §true switch final§
{
   ...
   public class §break use false§ extends §extends package import§
   {
      ...
      public function §break use false§(param1:int = 0, param2:String = "")
      {
         super();
         this.§dynamic finally var§ = param1;
         this.§while switch switch§ = param2;
