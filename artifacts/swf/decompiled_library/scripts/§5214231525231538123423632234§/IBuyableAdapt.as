package §5214231525231538123423632234§
{
   ...
   public class IBuyableAdapt implements §52142387523888123423632234§
   {
      
      private var object:§521423120252312038123423632234§;
      
      private var §extends class§:§52142387523888123423632234§;
      
      public function IBuyableAdapt(param1:§521423120252312038123423632234§, param2:§52142387523888123423632234§)
      {
         super();
         this.object = param1;
      ...
      public function isBuyable() : Boolean
      {
         ...
         try
         {
            ...
            _loc1_ = this.§extends class§.isBuyable();
         }
         finally
         {
            Model.popObject();
      ...
      public function getPriceWithoutDiscount() : int
      {
         ...
         try
         {
            ...
            platform.client.fp10.core.model.impl.Model.objects[platform.client.fp10.core.model.impl.Model.objects.length] = platform.client.fp10.core.model.impl.Model.§5214232533232546123423632234§;
            platform.client.fp10.core.model.impl.Model.§5214232533232546123423632234§ = _loc4_;
            _loc1_ = this.§extends class§.getPriceWithoutDiscount();
         }
         finally
         {
            Model.popObject();
      ...
      public function getPrice() : int
      {
         ...
         try
         {
            ...
            platform.client.fp10.core.model.impl.Model.objects[platform.client.fp10.core.model.impl.Model.objects.length] = platform.client.fp10.core.model.impl.Model.§5214232533232546123423632234§;
            platform.client.fp10.core.model.impl.Model.§5214232533232546123423632234§ = _loc4_;
            _loc1_ = this.§extends class§.getPrice();
         }
         finally
         {
            Model.popObject();
