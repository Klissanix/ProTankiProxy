package §throw package for§
{
   ...
   public class IRentEvents implements §return var function§
   {
      ...
      public function IRentEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      public function isForRent() : Boolean
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:§return var function§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §return var function§;
               _loc1_ = _loc3_.isForRent();
               _loc2_++;
            }
         }
         finally
