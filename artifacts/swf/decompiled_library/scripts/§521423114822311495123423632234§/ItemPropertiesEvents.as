package §521423114822311495123423632234§
{
   ...
   public class ItemPropertiesEvents implements §5214231204231217123423632234§
   {
      ...
      public function ItemPropertiesEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      public function getProperties() : Vector.<§for use use§>
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:§5214231204231217123423632234§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §5214231204231217123423632234§;
               _loc1_ = _loc3_.getProperties();
               _loc2_++;
            }
         }
         finally
