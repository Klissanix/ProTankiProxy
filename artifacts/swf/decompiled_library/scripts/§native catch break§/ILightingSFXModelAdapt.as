package §native catch break§
{
   ...
   public class ILightingSFXModelAdapt implements §return switch function§
   {
      
      private var object:§521423120252312038123423632234§;
      
      private var §extends class§:§return switch function§;
      
      public function ILightingSFXModelAdapt(param1:§521423120252312038123423632234§, param2:§return switch function§)
      {
         super();
         this.object = param1;
      ...
      public function getLightAnimation(param1:String) : LightAnimation
      {
         ...
         try
         {
            ...
            _loc2_ = this.§extends class§.getLightAnimation(param1);
         }
         finally
         {
            Model.popObject();
