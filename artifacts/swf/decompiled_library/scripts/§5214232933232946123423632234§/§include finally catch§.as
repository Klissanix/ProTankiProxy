package §5214232933232946123423632234§
{
   import §break use catch§.§extends package import§;
   
   public class §include finally catch§ extends §extends package import§
   {
      
      public var uid:String;
      
      public function §include finally catch§(param1:String = "")
      {
         super();
         this.uid = param1;
      ...
      {
         return new §include finally catch§();
      }
