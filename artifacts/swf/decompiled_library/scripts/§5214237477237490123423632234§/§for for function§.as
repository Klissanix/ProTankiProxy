package §5214237477237490123423632234§
{
   ...
   public class §for for function§ extends §final switch return§ implements §5214232204232217123423632234§
   {
      
      private var §catch switch function§:§switch var final§;
      
      private var §var for for§:§5214235777235790123423632234§;
      ...
      public function §for for function§(param1:§5214236270236283123423632234§)
      {
         super(param1);
         this.§var for for§ = new §5214235777235790123423632234§();
      }
      ...
      {
         this.§var for for§.§false set final§();
         this.§catch switch function§.§5214231752231765123423632234§(this.§var for for§);
      ...
      public function addedToScene(param1:§switch var final§) : void
      {
         ...
         param1.§5214237128237141123423632234§(this.§var for for§);
      }
      ...
      public function play(param1:int, param2:§521423132492313262123423632234§) : Boolean
      {
         ...
         SFXUtils.alignObjectPlaneToView(this.§var for for§,this.§5214234922234935123423632234§,this.§5214239673239686123423632234§,param2.§dynamic final§);
         _loc4_ = this.§dynamic finally var§ / this.§dynamic catch throw§;
         _loc3_ = Math.sqrt(_loc4_);
         this.§var for for§.scaleX = this.§5214232694232707123423632234§ + (this.§5214238334238347123423632234§ - this.§5214232694232707123423632234§) * _loc3_;
         this.§var for for§.alpha = 1 - _loc4_;
         this.§var for for§.§521423120402312053123423632234§(_loc3_);
      ...
      public function init(param1:Vector3, param2:Vector3, param3:Material, param4:Number, param5:Number, param6:Number, param7:Number, param8:int) : void
      {
         ...
         this.§var for for§.init(param4,_loc9_,param3,param7);
