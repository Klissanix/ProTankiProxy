package §override for continue§
{
   public class ColorMatrix extends DynamicMatrix
   {
      ...
      protected static const §521423114282311441123423632234§:Number = 0.3086;
      
      protected static const §5214233484233497123423632234§:Number = 0.6094;
      
      protected static const §5214234903234916123423632234§:Number = 0.082;
      ...
      {
         if(!§5214238917238930123423632234§)
         {
            return;
         }
         §5214238917238930123423632234§[0][4] = param1;
         §5214238917238930123423632234§[1][4] = param1;
         §5214238917238930123423632234§[2][4] = param1;
      }
      ...
      public function GetFlatArray() : Array
      {
         ...
         while(_loc2_ < 4)
         {
            ...
            while(_loc3_ < 5)
            {
               _loc4_[_loc1_] = §5214238917238930123423632234§[_loc2_][_loc3_];
               _loc1_++;
               _loc3_++;
            }
            _loc2_++;
      ...
      public function SetHueMatrix(param1:Number) : void
      {
         ...
         while(_loc7_ < 3)
         {
            ...
            while(_loc8_ < 3)
            {
               §5214238917238930123423632234§[_loc7_][_loc8_] = _loc4_.GetValue(_loc7_,_loc8_);
               _loc8_++;
            }
            _loc7_++;
         }
      ...
      public function SetContrastMatrix(param1:Number) : void
      {
         ...
         param1 /= 127;
         §5214238917238930123423632234§[0][0] = param1;
         §5214238917238930123423632234§[1][1] = param1;
         §5214238917238930123423632234§[2][2] = param1;
         §5214238917238930123423632234§[0][4] = _loc2_;
         §5214238917238930123423632234§[1][4] = _loc2_;
         §5214238917238930123423632234§[2][4] = _loc2_;
      }
      ...
      public function SetSaturationMatrix(param1:Number) : void
      {
         ...
         §5214238917238930123423632234§[0][0] = _loc3_ + param1;
         §5214238917238930123423632234§[1][0] = _loc3_;
         §5214238917238930123423632234§[2][0] = _loc3_;
         _loc3_ = _loc2_ * 0.6094;
         §5214238917238930123423632234§[0][1] = _loc3_;
         §5214238917238930123423632234§[1][1] = _loc3_ + param1;
         §5214238917238930123423632234§[2][1] = _loc3_;
         _loc3_ = _loc2_ * 0.082;
         §5214238917238930123423632234§[0][2] = _loc3_;
         §5214238917238930123423632234§[1][2] = _loc3_;
         §5214238917238930123423632234§[2][2] = _loc3_ + param1;
      }
   }
}
