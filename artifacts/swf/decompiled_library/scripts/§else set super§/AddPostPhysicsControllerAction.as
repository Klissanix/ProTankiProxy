package §else set super§
{
   ...
   public class AddPostPhysicsControllerAction extends BattleRunnerProvider implements §5214233428233441123423632234§
   {
      
      private var controller:§5214232465232478123423632234§;
      
      public function AddPostPhysicsControllerAction(param1:§5214232465232478123423632234§)
      {
         super();
