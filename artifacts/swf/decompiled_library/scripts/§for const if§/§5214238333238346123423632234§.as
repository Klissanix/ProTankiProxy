package §for const if§
{
   ...
   public class §5214238333238346123423632234§ extends BattleRunnerProvider implements §each package const§, §var implements§
   {
      ...
      public function §5214238333238346123423632234§(param1:§throw var§, param2:Number, param3:Number, param4:§override var if§)
      {
         super();
      ...
      public function §function package override§(param1:§const throw§, param2:Vector3, param3:Object3D) : void
      {
         ...
         {
            this.§extends const package§(param1,param2,param3);
            this.§null const extends§(param3);
            this.§5214232259232272123423632234§(param2,param3);
         }
      }
      
      public function §5214232259232272123423632234§(param1:Vector3, param2:Object3D) : void
      {
         var _loc3_:MuzzlePositionProvider = null;
         var _loc4_:CollisionObject3DPositionProvider = null;
         if(this.§each package dynamic§ == null)
         {
            ...
            _loc3_ = MuzzlePositionProvider(this.§52142383123844123423632234§.§52142349423507123423632234§(MuzzlePositionProvider));
            _loc3_.init(param2,param1);
            this.§each package dynamic§.init(_loc3_,this.§override set else§.§implements const continue§,this.§override set else§.§5214235965235978123423632234§);
         ...
         if(this.§native set use§ == null)
         {
            ...
            _loc4_.init(param2,param1,getBattleRunner().getCollisionDetector(),1500);
            this.§native set use§.init(_loc4_,this.§override set else§.§521423132152313228123423632234§,this.§override set else§.§implements class§);
      ...
      {
         var _loc2_:Sound3D = Sound3D.create(this.§override set else§.§return for break§,1);
         ...
         this.§5214236233236246123423632234§.shortInit(_loc2_,param1,this);
         getBattleRunner().getSoundManager().addEffect(this.§5214236233236246123423632234§);
      }
      
      private function §extends const package§(param1:§const throw§, param2:Vector3, param3:Object3D) : void
      {
         ...
         this.§5214234384234397123423632234§.init(param1,this.§false catch continue§,this.§521423990231003123423632234§,2000,param2,param3,this.§override set else§,getBattleRunner().getCollisionDetector(),210,350,75,450,90,40);
