package §521423103152310328123423632234§
{
   ...
   public class IBattleDMItemAdapt implements §static switch break§
   {
      
      private var object:§521423120252312038123423632234§;
      
      private var §extends class§:§static switch break§;
      
      public function IBattleDMItemAdapt(param1:§521423120252312038123423632234§, param2:§static switch break§)
      {
         super();
         this.object = param1;
      ...
      public function getUsersCount() : int
      {
         ...
         try
         {
            ...
            _loc1_ = this.§extends class§.getUsersCount();
         }
         finally
         {
            Model.popObject();
      ...
      public function getFriendsCount() : int
      {
         ...
         try
         {
            ...
            platform.client.fp10.core.model.impl.Model.objects[platform.client.fp10.core.model.impl.Model.objects.length] = platform.client.fp10.core.model.impl.Model.§5214232533232546123423632234§;
            platform.client.fp10.core.model.impl.Model.§5214232533232546123423632234§ = _loc4_;
            _loc1_ = this.§extends class§.getFriendsCount();
         }
         finally
         {
            Model.popObject();
