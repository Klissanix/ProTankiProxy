package §521423120482312061123423632234§
{
   ...
   public class BonusItemEvents implements BonusItem
   {
      ...
      public function BonusItemEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      public function getItem() : §5214231187231200123423632234§
      {
         ...
         try
         {
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as BonusItem;
               _loc1_ = _loc3_.getItem();
               _loc2_++;
            }
         }
         finally
