package §521423100272310040123423632234§
{
   ...
   public class IProBattleEvents implements §5214236663236676123423632234§
   {
      ...
      public function IProBattleEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      public function getEnterPrice() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:§5214236663236676123423632234§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §5214236663236676123423632234§;
               _loc1_ = _loc3_.getEnterPrice();
               _loc2_++;
            }
         }
         finally
      ...
      public function getTimeLeftInSec() : int
      {
         ...
         try
         {
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §5214236663236676123423632234§;
               _loc1_ = _loc3_.getTimeLeftInSec();
               _loc2_++;
            }
         }
         finally
