package alternativa.tanks.model.info
{
   ...
   public class IBattleInfoEvents implements §5214234313234326123423632234§
   {
      ...
      public function IBattleInfoEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      public function getPreviewResource() : §include catch with§
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:§5214234313234326123423632234§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §5214234313234326123423632234§;
