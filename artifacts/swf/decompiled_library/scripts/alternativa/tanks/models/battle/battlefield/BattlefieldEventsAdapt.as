package alternativa.tanks.models.battle.battlefield
{
   ...
   public class BattlefieldEventsAdapt implements §else catch switch§
   {
      
      private var object:§521423120252312038123423632234§;
      
      private var §extends class§:§else catch switch§;
      
      public function BattlefieldEventsAdapt(param1:§521423120252312038123423632234§, param2:§else catch switch§)
      {
         super();
         this.object = param1;
      ...
      public function onBattleLoaded() : void
      {
         try
         {
            ...
            this.§extends class§.onBattleLoaded();
         }
         finally
         {
            Model.popObject();
