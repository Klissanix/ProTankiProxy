package alternativa.math
{
   ...
   public class Quaternion
   {
      ...
      private static const §5214238518238531123423632234§:Quaternion = new Quaternion();
      ...
      public function slerp(param1:Quaternion, param2:Quaternion, param3:Number) : Quaternion
      {
         ...
         var _loc9_:Number = 1;
         var _loc7_:Number = param1.w * param2.w + param1.x * param2.x + param1.y * param2.y + param1.z * param2.z;
         if(_loc7_ < 0)
         {
            _loc7_ = -_loc7_;
            _loc9_ = -1;
         ...
         else
         {
            ...
            this.w = param1.w * _loc11_ + param2.w * _loc6_;
            this.x = param1.x * _loc11_ + param2.x * _loc6_;
            this.y = param1.y * _loc11_ + param2.y * _loc6_;
            this.z = param1.z * _loc11_ + param2.z * _loc6_;
         }
         return this;
      }
      ...
      public function getZAxis(param1:Vector3) : Vector3
      {
         ...
         var _loc2_:Number = 2 * this.y * this.z;
         var _loc7_:Number = 2 * this.z * this.x;
         var _loc3_:Number = 2 * this.w * this.x;
         var _loc4_:Number = 2 * this.w * this.y;
         param1.x = _loc7_ + _loc4_;
         param1.y = _loc2_ - _loc3_;
         param1.z = 1 - _loc5_ - _loc6_;
         return param1;
      }
      ...
      public function addScaledVector(param1:Vector3, param2:Number) : Quaternion
      {
         ...
         var _loc9_:Number = param1.z * param2;
         var _loc3_:Number = -this.x * _loc7_ - this.y * _loc8_ - this.z * _loc9_;
         var _loc4_:Number = _loc7_ * this.w + _loc8_ * this.z - _loc9_ * this.y;
         var _loc5_:Number = _loc8_ * this.w + _loc9_ * this.x - _loc7_ * this.z;
         var _loc6_:Number = _loc9_ * this.w + _loc7_ * this.y - _loc8_ * this.x;
         this.w += 0.5 * _loc3_;
         this.x += 0.5 * _loc4_;
         this.y += 0.5 * _loc5_;
         this.z += 0.5 * _loc6_;
      ...
      public function setFromEulerAnglesXYZ(param1:Number, param2:Number, param3:Number) : void
      {
         ...
         §5214238518238531123423632234§.setFromAxisAngleComponents(0,1,0,param2);
         this.append(§5214238518238531123423632234§);
         this.normalize();
         §5214238518238531123423632234§.setFromAxisAngleComponents(0,0,1,param3);
         this.append(§5214238518238531123423632234§);
         this.normalize();
      }
      ...
      public function toMatrix4(param1:Matrix4) : Quaternion
      {
         ...
         var _loc8_:Number = 2 * this.z * this.z;
         var _loc2_:Number = 2 * this.x * this.y;
         var _loc3_:Number = 2 * this.y * this.z;
         var _loc9_:Number = 2 * this.z * this.x;
         var _loc4_:Number = 2 * this.w * this.x;
         var _loc5_:Number = 2 * this.w * this.y;
         var _loc10_:Number = 2 * this.w * this.z;
         param1.m00 = 1 - _loc7_ - _loc8_;
         param1.§5214239800239813123423632234§ = _loc2_ - _loc10_;
         param1.§521423117972311810123423632234§ = _loc9_ + _loc5_;
         param1.§5214234411234424123423632234§ = _loc2_ + _loc10_;
         param1.m11 = 1 - _loc6_ - _loc8_;
         param1.§null use use§ = _loc3_ - _loc4_;
         param1.§521423135662313579123423632234§ = _loc9_ - _loc5_;
         param1.§case set function§ = _loc3_ + _loc4_;
         param1.m22 = 1 - _loc6_ - _loc7_;
         return this;
      }
      ...
      public function isFiniteQuaternion() : Boolean
      {
         ...
         return _loc1_(this.w) && _loc1_(this.x) && _loc1_(this.y) && _loc1_(this.z);
      }
      ...
      {
         var _loc5_:Number = 2 * this.x * this.x;
         var _loc6_:Number = 2 * this.z * this.z;
         var _loc2_:Number = 2 * this.x * this.y;
         var _loc3_:Number = 2 * this.y * this.z;
         var _loc4_:Number = 2 * this.w * this.x;
      ...
      public function getEulerAngles(param1:Vector3) : Vector3
      {
         ...
         var _loc16_:Number = 2 * this.z * this.z;
         var _loc13_:Number = 2 * this.x * this.y;
         var _loc14_:Number = 2 * this.y * this.z;
         var _loc12_:Number = 2 * this.z * this.x;
         var _loc10_:Number = 2 * this.w * this.x;
         var _loc9_:Number = 2 * this.w * this.y;
         var _loc11_:Number = 2 * this.w * this.z;
         ...
         if(-1 < _loc6_ && _loc6_ < 1)
         {
            if(param1 == null)
            {
               param1 = new Vector3(Math.atan2(_loc7_,_loc8_),-Math.asin(_loc6_),Math.atan2(_loc4_,_loc2_));
            }
            else
            {
               param1.x = Math.atan2(_loc7_,_loc8_);
               param1.y = -Math.asin(_loc6_);
               param1.z = Math.atan2(_loc4_,_loc2_);
            }
         }
         else if(param1 == null)
         {
            param1 = new Vector3(0,0.5 * (_loc6_ <= -1 ? 3.141592653589793 : -3.141592653589793),Math.atan2(-_loc3_,_loc5_));
         }
         else
         {
            param1.x = 0;
            ...
            param1.y *= 0.5;
            param1.z = Math.atan2(-_loc3_,_loc5_);
         }
         return param1;
      }
