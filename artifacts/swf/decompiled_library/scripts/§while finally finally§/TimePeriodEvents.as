package §while finally finally§
{
   import platform.client.fp10.core.model.impl.*;
   import platform.client.fp10.core.type.§521423120252312038123423632234§;
   
   public class TimePeriodEvents implements §521423108722310885123423632234§
   {
      ...
      public function TimePeriodEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      public function getTimeLeftInSeconds() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:§521423108722310885123423632234§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §521423108722310885123423632234§;
               _loc1_ = _loc3_.getTimeLeftInSeconds();
               _loc2_++;
            }
         }
         finally
      ...
      public function getTimeToStartInSeconds() : int
      {
         ...
         try
         {
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §521423108722310885123423632234§;
               _loc1_ = _loc3_.getTimeToStartInSeconds();
               _loc2_++;
            }
         }
         finally
      ...
      public function getModelLoadingTimeInMillis() : int
      {
         ...
         try
         {
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §521423108722310885123423632234§;
               _loc1_ = _loc3_.getModelLoadingTimeInMillis();
               _loc2_++;
            }
         }
         finally
