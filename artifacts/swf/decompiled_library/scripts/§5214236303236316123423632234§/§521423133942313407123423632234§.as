package §5214236303236316123423632234§
{
   ...
   public class §521423133942313407123423632234§ extends §final switch return§ implements §final use while§
   {
      
      public static const §continue catch extends§:Number = 48;
      ...
      private var §switch package get§:§throw for package§;
      
      private var §catch switch function§:§switch var final§;
      
      public function §521423133942313407123423632234§(param1:§5214236270236283123423632234§)
      {
         super(param1);
         this.§switch package get§ = new §throw for package§();
      }
