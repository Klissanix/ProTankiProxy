package §5214236303236316123423632234§
{
   ...
   internal class §throw for package§ extends Mesh
   {
      ...
      public function §throw for package§()
      {
         super();
         this.§5214238602238615123423632234§ = this.§in catch extends§(-1,-1,0,0,1);
         this.b = this.§in catch extends§(1,-1,0,1,1);
         this.§5214236214236227123423632234§ = this.§in catch extends§(1,0,0,1,0);
         this.§in var continue§ = this.§in catch extends§(-1,0,0,0,0);
      ...
      {
         return -this.§5214238602238615123423632234§.y;
      }
      ...
      public function init(param1:Number, param2:Number, param3:Number, param4:Material) : void
      {
         ...
         _loc6_ = -param2;
         this.b.y = -param2;
         boundMinY = this.§5214238602238615123423632234§.y = _loc6_;
         boundMaxY = 0;
      ...
      public function set §in set use§(param1:Number) : void
      {
         ...
         this.b.y = -param1;
         boundMinY = this.§5214238602238615123423632234§.y = _loc2_;
      }
   }
}
