package §5214231383231396123423632234§
{
   ...
   import §5214238004238017123423632234§.§for var import§;
   import §5214238004238017123423632234§.§include for class§;
   import §5214238004238017123423632234§.§true use else§;
   ...
   public class §finally finally finally§ extends §include for class§ implements §for var import§, §5214237250237263123423632234§, §finally catch break§, §if use default§
   {
      ...
      public function §finally finally finally§()
      {
         super();
      ...
      private function §import catch break§(param1:TankUnloadedEvent) : void
      {
         ...
         if(this.§5214233072233085123423632234§ == _loc2_)
         {
      ...
      public function §5214238937238950123423632234§(param1:ClientObject) : §import catch null§
      {
         ...
         var _loc3_:§5214236557236570123423632234§ = §super var dynamic§(OSGi.getInstance().getService(LocalTankInfoService)).getTankData(param1);
         var _loc10_:§static set true§ = §52142380523818123423632234§.getBattleRunner().getCollisionDetector();
         var _loc11_:§override var implements§ = §override var implements§(_loc3_.§catch use continue§.getParams(§override var implements§));
         var _loc8_:§const const return§ = new §const const return§(_loc11_.§5214232973232986123423632234§(),_loc11_.§5214239218239231123423632234§(),5,6,_loc10_,§52142380523818123423632234§.getConicAreaTargetValidator());
         var _loc9_:§true const each§ = new §true const each§();
         var _loc6_:§5214231241231254123423632234§ = §521423134772313490123423632234§(_loc3_.§catch use continue§);
         var _loc7_:Number = _loc6_.§5214236004236017123423632234§();
         var _loc5_:Number = _loc6_.§var catch const§();
         var _loc4_:Number = _loc6_.§5214231609231622123423632234§();
         var _loc2_:§import catch null§ = new §521423127952312808123423632234§(_loc7_,_loc5_,_loc4_,_loc6_.§521423126952312708123423632234§(),_loc8_,_loc9_,this,this.§with const native§(param1));
      ...
      {
         var _loc2_:§true use else§ = §switch var switch§();
         var _loc3_:§override var implements§ = new §override var implements§(_loc2_.§521423109062310919123423632234§,BattleUtils.toClientScale(_loc2_.§false catch continue§));
      ...
      private function §with const native§(param1:ClientObject) : §each package const§
      {
         ...
         var _loc4_:§each use case§ = §5214233861233874123423632234§.§with switch native§(param1);
         return _loc4_.§true switch else§(_loc3_.§5214232973232986123423632234§(),_loc3_.§5214239218239231123423632234§(),param1);
      }
   }
}
