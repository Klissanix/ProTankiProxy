package §5214232638232651123423632234§
{
   ...
   public class TeamBattleInfoModelServer
   {
      ...
      public function TeamBattleInfoModelServer(param1:§while for try§)
      {
         super();
      }
      
      public function fight(param1:§5214231658231671123423632234§) : void
      {
         §521423140132314026123423632234§.send(new §521423110182311031123423632234§(param1));
      }
   }
}
