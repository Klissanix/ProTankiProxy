package §class switch in§
{
   ...
   public class §include use implements§ implements §5214237664237677123423632234§
   {
      ...
      public function §include use implements§(param1:§var var each§)
      {
         super();
      ...
      public function §5214239313239326123423632234§(param1:Array) : Boolean
      {
         ...
         §5214232378232391123423632234§.unblockUser(_loc2_);
         this.§super set continue§.§while var var§(§5214236363236376123423632234§.getText("CHAT_PANEL_COMMAND_UNBLOCK",_loc2_));
         return true;
      }
   }
}
