package §5214239374239387123423632234§
{
   ...
   public class IClanInfoEvents implements §null override§
   {
      ...
      public function IClanInfoEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      public function getClanLink() : String
      {
         ...
         try
         {
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §null override§;
               _loc1_ = _loc3_.getClanLink();
               _loc2_++;
            }
         }
         finally
