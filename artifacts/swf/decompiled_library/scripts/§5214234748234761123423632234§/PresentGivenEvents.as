package §5214234748234761123423632234§
{
   ...
   public class PresentGivenEvents implements §521423121342312147123423632234§
   {
      ...
      public function PresentGivenEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:§521423121342312147123423632234§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §521423121342312147123423632234§;
               _loc3_.removePresent(param1);
               _loc2_++;
            }
         }
         finally
