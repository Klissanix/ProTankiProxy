package §while switch throw§
{
   ...
   public class IBonusLightEvents implements §final use super§
   {
      ...
      public function IBonusLightEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      {
         var _loc1_:BonusLight = null;
         var _loc2_:int = 0;
         var _loc3_:§final use super§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc3_ = this.§extends class§[_loc2_] as §final use super§;
               _loc1_ = _loc3_.getBonusLight();
               _loc2_++;
            }
         }
         finally
