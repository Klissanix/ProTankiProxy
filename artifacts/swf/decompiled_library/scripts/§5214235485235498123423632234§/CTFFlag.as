package §5214235485235498123423632234§
{
   ...
   public class CTFFlag implements §if use dynamic§, §5214234639234652123423632234§, §override for default§
   {
      ...
      private var §break throw§:int = 1000;
      ...
      public function CTFFlag(param1:§5214231658231671123423632234§, param2:Vector3, param3:int, param4:int, param5:TextureAnimation, param6:§5214234380234393123423632234§, param7:§true var finally§)
      {
         super();
         this.§else switch do§ = CTFFlagState.AT_BASE;
         this.teamType = param1;
         this.§52142385223865123423632234§ = param2.clone();
         this.§else switch do§ = CTFFlagState.AT_BASE;
         this.§dynamic use switch§ = param6;
         this.callback = param7;
         this.createSkin(param3,param4,param5);
         this.e1cec72b(param1);
         this.setPosition(param2);
         this.startTime = this.§break throw§ * Math.random();
      }
      ...
      {
         this.skin.setFrameIndex(int((param1 - this.startTime) / this.§break throw§));
