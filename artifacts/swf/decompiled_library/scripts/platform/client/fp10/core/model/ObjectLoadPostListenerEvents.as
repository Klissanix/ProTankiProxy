package platform.client.fp10.core.model
{
   ...
   public class ObjectLoadPostListenerEvents implements §5214234168234181123423632234§
   {
      ...
      public function ObjectLoadPostListenerEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:§5214234168234181123423632234§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc2_ = this.§extends class§[_loc1_] as §5214234168234181123423632234§;
