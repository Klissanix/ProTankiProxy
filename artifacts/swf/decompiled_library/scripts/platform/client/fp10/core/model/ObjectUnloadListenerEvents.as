package platform.client.fp10.core.model
{
   ...
   public class ObjectUnloadListenerEvents implements §throw catch var§
   {
      ...
      public function ObjectUnloadListenerEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:§throw catch var§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc2_ = this.§extends class§[_loc1_] as §throw catch var§;
