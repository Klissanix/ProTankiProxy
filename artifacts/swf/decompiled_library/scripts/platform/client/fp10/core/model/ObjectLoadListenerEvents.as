package platform.client.fp10.core.model
{
   ...
   public class ObjectLoadListenerEvents implements §do set function§
   {
      ...
      public function ObjectLoadListenerEvents(param1:§521423120252312038123423632234§, param2:Vector.<Object>)
      {
         super();
         this.object = param1;
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:§do set function§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc2_ = this.§extends class§[_loc1_] as §do set function§;
               _loc2_.objectLoaded();
               _loc1_++;
            }
         }
