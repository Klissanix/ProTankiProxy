package §each var null§
{
   ...
   public class §true set static§
   {
      
      public function §true set static§()
      {
         super();
      }
      
      public static function §default for switch§(param1:Number, param2:Vector3, param3:Matrix3) : void
      {
         if(param1 <= 0)
         {
      ...
      public static function §true switch return§(param1:Number, param2:Number, param3:Number, param4:Matrix3) : void
      {
         if(param1 <= 0)
         {
            throw new ArgumentError();
