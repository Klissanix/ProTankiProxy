package alternativa.tanks.materials
{
   ...
   public class AnimatedPaintFragmentShader extends FragmentShader
   {
      ...
      public function AnimatedPaintFragmentShader(param1:Boolean, param2:Boolean, param3:Boolean, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:Boolean, param13:Boolean, param14:Boolean, param15:Boolean, param16:Boolean, param17:Boolean, param18:Boolean)
      {
         ...
         tex(ft0,ft4,fs4.dim(SamplerDim.D2).repeat(_loc19_).filter(_loc20_).mipmap(_loc22_).type(_loc23_));
         tex(ft1,v0,fs6.dim(SamplerDim.D2).repeat(_loc19_).filter(_loc20_).mipmap(_loc22_).type(_loc23_));
         mul(ft2,ft0,ft1);
         mul(ft2,fc[23].w,ft2);
         sub(ft3,fc[23].z,ft0);
         sub(ft4,fc[23].z,ft1);
         ...
         mul(ft3,ft3,ft4);
         sub(ft3,fc[23].z,ft3);
         sge(ft4.x,ft1.x,fc[23].y);
         sub(ft4.y,fc[23].z,ft4.x);
         mul(ft5,ft4.x,ft3);
         mul(ft6,ft4.y,ft2);
         add(ft0,ft5,ft6);
         mov(ft0.w,ft1.w);
         tex(ft1,v0,fs0.dim(SamplerDim.D2).repeat(_loc19_).filter(_loc20_).mipmap(_loc22_).type(_loc23_));
