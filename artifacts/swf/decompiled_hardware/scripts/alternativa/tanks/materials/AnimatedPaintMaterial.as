package alternativa.tanks.materials
{
   ...
   import alternativa.engine3d.materials.TextureMaterialVertexShader;
   ...
   public class AnimatedPaintMaterial extends PaintMaterial
   {
      ...
      private var f3102b3a:int = -1;
      
      private var fps:int;
      
      private var numFrames:int;
      
      private var e5f50174:int;
      
      private var a97721d:int;
      
      private var e4732163:Number;
      ...
      public function AnimatedPaintMaterial(param1:BitmapData, param2:BitmapData, param3:BitmapData, param4:int, param5:int, param6:int, param7:int, param8:int = 0)
      {
         ...
         fragConst = new <Number>[0,0.5,1,2,this.frameWidth,this.frameHeight,0,0];
      }
      ...
      public function update() : void
      {
         ...
         this.time = _loc3_;
         this.e4732163 += _loc4_ / 1000 * this.fps;
         this.e4732163 %= this.numFrames;
         if(this.f3102b3a == this.e4732163)
         {
            return;
         }
         var _loc1_:int = this.e4732163 % this.e5f50174;
         var _loc2_:int = this.e4732163 / this.a97721d;
         this.f3102b3a = this.e4732163;
         uvTransformConst[0] = this.scaleX;
         uvTransformConst[1] = 0;
         uvTransformConst[2] = _loc1_ * this.frameWidth;
         uvTransformConst[3] = 0;
         uvTransformConst[4] = 0;
         uvTransformConst[5] = this.scaleY;
         uvTransformConst[6] = _loc2_ * this.frameHeight;
      ...
      override protected function getProgram(param1:Boolean, param2:Boolean, param3:Boolean, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:Boolean, param13:Boolean, param14:Boolean, param15:Boolean, param16:Boolean, param17:Boolean, param18:Boolean, param19:Boolean, param20:Boolean, param21:Boolean, param22:Boolean) : ProgramResource
      {
         ...
         var _loc23_:ProgramResource = this.a595de16[_loc24_];
         if(_loc23_ == null)
         {
            _loc25_ = new TextureMaterialVertexShader(!param22,param14 || param11 || param12 || param17,param13,param4,param14,param10,param2,param3,param3,param19,true,false).agalcode;
