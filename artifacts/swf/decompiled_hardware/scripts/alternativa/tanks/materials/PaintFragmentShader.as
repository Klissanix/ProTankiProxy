package alternativa.tanks.materials
{
   ...
   public class PaintFragmentShader extends FragmentShader
   {
      ...
      public function PaintFragmentShader(param1:Boolean, param2:Boolean, param3:Boolean, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:Boolean, param13:Boolean, param14:Boolean, param15:Boolean, param16:Boolean, param17:Boolean, param18:Boolean, param19:Boolean)
      {
         ...
         tex(ft0,v6,fs4.dim(SamplerDim.D2).repeat(_loc20_).filter(_loc21_).mipmap(_loc23_).type(_loc24_));
         tex(ft1,v0,fs6.dim(SamplerDim.D2).repeat(_loc20_).filter(_loc21_).mipmap(_loc23_).type(_loc24_));
         mul(ft2,ft0,ft1);
         mul(ft2,fc[23].w,ft2);
         sub(ft3,fc[23].z,ft0);
         sub(ft4,fc[23].z,ft1);
         ...
         add(ft0,ft5,ft6);
         mov(ft0.w,ft1.w);
         tex(ft1,v0,fs0.dim(SamplerDim.D2).repeat(_loc20_).filter(_loc21_).mipmap(_loc23_).type(_loc24_));
