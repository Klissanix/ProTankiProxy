package alternativa.engine3d.core
{
   ...
   public class Object3D implements IEventDispatcher
   {
      ...
      private static const d2792066:Vector3D = new Vector3D();
      ...
      alternativa3d var colorConst:Vector.<Number> = new <Number>[0,0,0,1,0,0,0,1];
      ...
      public function get matrix() : Matrix3D
      {
         ...
         return new Matrix3D(new <Number>[tA.ma,tA.me,tA.mi,0,tA.mb,tA.mf,tA.mj,0,tA.mc,tA.mg,tA.mk,0,tA.md,tA.mh,tA.ml,1]);
      }
      
      public function set matrix(param1:Matrix3D) : void
      {
         var _loc5_:Vector.<Vector3D> = param1.decompose();
         var _loc4_:Vector3D = _loc5_[0];
         var _loc2_:Vector3D = _loc5_[1];
         var _loc3_:Vector3D = _loc5_[2];
         this.x = _loc4_.x;
         this.y = _loc4_.y;
         this.z = _loc4_.z;
         this.rotationX = _loc2_.x;
         this.rotationY = _loc2_.y;
         this.rotationZ = _loc2_.z;
         this.scaleX = _loc3_.x;
         this.scaleY = _loc3_.y;
         this.scaleZ = _loc3_.z;
      }
      ...
      public function getConcatenatedMatrixRaw(param1:Vector.<Number>) : Vector.<Number>
      {
         tA.composeMatrixFromSource(this);
      ...
      public function addEventListener(param1:String, param2:Function, param3:Boolean = false, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         else
         {
            ...
            _loc7_ = this.bubbleListeners;
         }
         var _loc6_:Vector.<Function> = _loc7_[param1];
         if(_loc6_ == null)
         {
      ...
      public function removeEventListener(param1:String, param2:Function, param3:Boolean = false) : void
      {
         ...
         var _loc5_:Object = param3 ? this.captureListeners : this.bubbleListeners;
         if(_loc5_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc7_ >= 0)
               {
                  ...
                  else
                  {
                     ...
                     var _loc11_:int = 0;
                     var _loc10_:Object = _loc5_;
                     for(_loc9_ in _loc10_)
                     {
                     }
                     if(!_loc9_)
                     {
                        if(_loc5_ == this.captureListeners)
                        {
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         ...
         while(_loc7_ < _loc4_)
         {
            ...
            if(param1 is MouseEvent3D)
            {
               MouseEvent3D(param1).alternativa3d::_currentTarget = _loc9_;
            }
            if(this.bubbleListeners != null)
            {
               _loc2_ = this.bubbleListeners[param1.type];
               if(_loc2_ != null)
               {
                  ...
                  while(_loc8_ < _loc5_)
                  {
                     _loc6_[_loc8_] = _loc2_[_loc8_];
                     _loc8_++;
                  }
                  _loc8_ = 0;
                  while(_loc8_ < _loc5_)
                  {
                     (_loc6_[_loc8_] as Function).call(null,param1);
                     _loc8_++;
                  }
               }
            }
      ...
      alternativa3d function boundCheckIntersection(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number, param11:Number, param12:Number, param13:Number) : Boolean
      {
         ...
         var _loc17_:Number = param1 + param4 * param7;
         var _loc21_:Number = param2 + param5 * param7;
         var _loc20_:Number = param3 + param6 * param7;
         if(param1 >= param8 && param1 <= param11 && param2 >= param9 && param2 <= param12 && param3 >= param10 && param3 <= param13 || _loc17_ >= param8 && _loc17_ <= param11 && _loc21_ >= param9 && _loc21_ <= param12 && _loc20_ >= param10 && _loc20_ <= param13)
         {
            return true;
         }
         if(param1 < param8 && _loc17_ < param8 || param1 > param11 && _loc17_ > param11 || param2 < param9 && _loc21_ < param9 || param2 > param12 && _loc21_ > param12 || param3 < param10 && _loc20_ < param10 || param3 > param13 && _loc20_ > param13)
         {
            return false;
         }
         var _loc19_:Number = 0.000001;
         if(param4 > _loc19_)
         {
            _loc14_ = (param8 - param1) / param4;
            _loc15_ = (param11 - param1) / param4;
         }
         else if(param4 < -_loc19_)
         {
         ...
         if(param5 > _loc19_)
         {
            ...
            _loc18_ = (param12 - param2) / param5;
         }
         else if(param5 < -_loc19_)
         {
            _loc16_ = (param12 - param2) / param5;
            _loc18_ = (param9 - param2) / param5;
         }
         else
         {
            _loc16_ = 0;
         ...
         if(_loc16_ >= _loc15_ || _loc18_ <= _loc14_)
         {
            return false;
         }
         if(_loc16_ < _loc14_)
         ...
         if(param6 > _loc19_)
         {
            ...
            _loc18_ = (param13 - param3) / param6;
         }
         else if(param6 < -_loc19_)
         {
            _loc16_ = (param13 - param3) / param6;
            _loc18_ = (param10 - param3) / param6;
         }
         else
         {
            _loc16_ = 0;
      ...
      protected function clonePropertiesFrom(param1:Object3D) : void
      {
         ...
         {
            this.filters = [].concat(param1.filters);
         }
         this.x = param1.x;
         this.y = param1.y;
         this.z = param1.z;
      ...
      alternativa3d function calculateSphere(param1:Vector3D, param2:Vector3D, param3:Vector3D, param4:Vector3D, param5:Vector3D, param6:Vector3D = null) : Vector3D
      {
         ...
         var _loc20_:Number = this.ima * param1.x + this.imb * param1.y + this.imc * param1.z + this.imd;
         var _loc16_:Number = this.ime * param1.x + this.imf * param1.y + this.img * param1.z + this.imh;
         var _loc8_:Number = this.imi * param1.x + this.imj * param1.y + this.imk * param1.z + this.iml;
         var _loc26_:Number = this.ima * param2.x + this.imb * param2.y + this.imc * param2.z + this.imd;
         var _loc23_:Number = this.ime * param2.x + this.imf * param2.y + this.img * param2.z + this.imh;
         var _loc18_:Number = this.imi * param2.x + this.imj * param2.y + this.imk * param2.z + this.iml;
         var _loc24_:Number = this.ima * param3.x + this.imb * param3.y + this.imc * param3.z + this.imd;
         var _loc7_:Number = this.ime * param3.x + this.imf * param3.y + this.img * param3.z + this.imh;
         var _loc19_:Number = this.imi * param3.x + this.imj * param3.y + this.imk * param3.z + this.iml;
         var _loc25_:Number = this.ima * param4.x + this.imb * param4.y + this.imc * param4.z + this.imd;
         var _loc15_:Number = this.ime * param4.x + this.imf * param4.y + this.img * param4.z + this.imh;
         var _loc9_:Number = this.imi * param4.x + this.imj * param4.y + this.imk * param4.z + this.iml;
         var _loc22_:Number = this.ima * param5.x + this.imb * param5.y + this.imc * param5.z + this.imd;
         var _loc17_:Number = this.ime * param5.x + this.imf * param5.y + this.img * param5.z + this.imh;
         var _loc21_:Number = this.imi * param5.x + this.imj * param5.y + this.imk * param5.z + this.iml;
         var _loc14_:Number = _loc26_ - _loc20_;
         var _loc10_:Number = _loc23_ - _loc16_;
         var _loc11_:Number = _loc18_ - _loc8_;
         var _loc13_:Number = _loc14_ * _loc14_ + _loc10_ * _loc10_ + _loc11_ * _loc11_;
         _loc14_ = _loc24_ - _loc20_;
         _loc10_ = _loc7_ - _loc16_;
         _loc11_ = _loc19_ - _loc8_;
         var _loc12_:Number = _loc14_ * _loc14_ + _loc10_ * _loc10_ + _loc11_ * _loc11_;
         if(_loc12_ > _loc13_)
         {
            _loc13_ = _loc12_;
         }
         _loc14_ = _loc25_ - _loc20_;
         _loc10_ = _loc15_ - _loc16_;
         _loc11_ = _loc9_ - _loc8_;
         _loc12_ = _loc14_ * _loc14_ + _loc10_ * _loc10_ + _loc11_ * _loc11_;
         if(_loc12_ > _loc13_)
         {
            _loc13_ = _loc12_;
         }
         _loc14_ = _loc22_ - _loc20_;
         _loc10_ = _loc17_ - _loc16_;
         _loc11_ = _loc21_ - _loc8_;
         _loc12_ = _loc14_ * _loc14_ + _loc10_ * _loc10_ + _loc11_ * _loc11_;
         if(_loc12_ > _loc13_)
         {
            _loc13_ = _loc12_;
      ...
      alternativa3d function calculatePlane(param1:Vector3D, param2:Vector3D, param3:Vector3D) : Vector3D
      {
         ...
         var _loc5_:Number = param3.z - param1.z;
         _loc7_.x = _loc5_ * _loc6_ - _loc10_ * _loc9_;
         _loc7_.y = _loc8_ * _loc9_ - _loc5_ * _loc11_;
         _loc7_.z = _loc10_ * _loc11_ - _loc8_ * _loc6_;
         var _loc4_:Number = _loc7_.x * _loc7_.x + _loc7_.y * _loc7_.y + _loc7_.z * _loc7_.z;
         if(_loc4_ > 0.0001)
         {
         ...
         _loc7_.w = param1.x * _loc7_.x + param1.y * _loc7_.y + param1.z * _loc7_.z;
         return _loc7_;
      }
      
      alternativa3d function composeMatrix() : void
      {
         var _loc5_:Number = Math.cos(this.rotationX);
         var _loc6_:Number = Math.sin(this.rotationX);
         var _loc13_:Number = Math.cos(this.rotationY);
         var _loc7_:Number = Math.sin(this.rotationY);
         var _loc4_:Number = Math.cos(this.rotationZ);
         var _loc10_:Number = Math.sin(this.rotationZ);
         var _loc2_:Number = _loc4_ * _loc7_;
         var _loc3_:Number = _loc10_ * _loc7_;
         var _loc9_:Number = _loc13_ * this.scaleX;
         var _loc11_:Number = _loc6_ * this.scaleY;
         var _loc12_:Number = _loc5_ * this.scaleY;
         var _loc1_:Number = _loc5_ * this.scaleZ;
         var _loc8_:Number = _loc6_ * this.scaleZ;
         this.ma = _loc4_ * _loc9_;
         this.mb = _loc2_ * _loc11_ - _loc10_ * _loc12_;
         this.mc = _loc2_ * _loc1_ + _loc10_ * _loc8_;
         this.md = this.x;
         this.me = _loc10_ * _loc9_;
         this.mf = _loc3_ * _loc11_ + _loc4_ * _loc12_;
         this.mg = _loc3_ * _loc1_ - _loc4_ * _loc8_;
         this.mh = this.y;
         this.mi = -_loc7_ * this.scaleX;
         this.mj = _loc13_ * _loc11_;
         this.mk = _loc13_ * _loc1_;
         this.ml = this.z;
      }
      
      alternativa3d function composeMatrixFromSource(param1:Object3D) : void
      {
         var _loc6_:Number = Math.cos(param1.rotationX);
         var _loc7_:Number = Math.sin(param1.rotationX);
         var _loc14_:Number = Math.cos(param1.rotationY);
         var _loc8_:Number = Math.sin(param1.rotationY);
         var _loc5_:Number = Math.cos(param1.rotationZ);
         var _loc11_:Number = Math.sin(param1.rotationZ);
         var _loc3_:Number = _loc5_ * _loc8_;
         var _loc4_:Number = _loc11_ * _loc8_;
         var _loc10_:Number = _loc14_ * param1.scaleX;
         var _loc12_:Number = _loc7_ * param1.scaleY;
         var _loc13_:Number = _loc6_ * param1.scaleY;
         var _loc2_:Number = _loc6_ * param1.scaleZ;
         var _loc9_:Number = _loc7_ * param1.scaleZ;
         this.ma = _loc5_ * _loc10_;
         this.mb = _loc3_ * _loc12_ - _loc11_ * _loc13_;
         this.mc = _loc3_ * _loc2_ + _loc11_ * _loc9_;
         this.md = param1.x;
         this.me = _loc11_ * _loc10_;
         this.mf = _loc4_ * _loc12_ + _loc5_ * _loc13_;
         this.mg = _loc4_ * _loc2_ - _loc5_ * _loc9_;
         this.mh = param1.y;
         this.mi = -_loc8_ * param1.scaleX;
         this.mj = _loc14_ * _loc12_;
         this.mk = _loc14_ * _loc2_;
         this.ml = param1.z;
      }
      ...
      {
         var _loc4_:Number = Math.cos(this.rotationX);
         var _loc5_:Number = Math.sin(this.rotationX);
         var _loc26_:Number = Math.cos(this.rotationY);
         var _loc22_:Number = Math.sin(this.rotationY);
         var _loc14_:Number = Math.cos(this.rotationZ);
         var _loc24_:Number = Math.sin(this.rotationZ);
         var _loc2_:Number = _loc14_ * _loc22_;
         var _loc3_:Number = _loc24_ * _loc22_;
         var _loc7_:Number = _loc26_ * this.scaleX;
         var _loc25_:Number = _loc5_ * this.scaleY;
         var _loc8_:Number = _loc4_ * this.scaleY;
         var _loc9_:Number = _loc4_ * this.scaleZ;
         var _loc6_:Number = _loc5_ * this.scaleZ;
         var _loc10_:Number = _loc14_ * _loc7_;
         var _loc11_:Number = _loc2_ * _loc25_ - _loc24_ * _loc8_;
         var _loc12_:Number = _loc2_ * _loc9_ + _loc24_ * _loc6_;
         var _loc13_:Number = this.x;
         var _loc15_:Number = _loc24_ * _loc7_;
         var _loc16_:Number = _loc3_ * _loc25_ + _loc14_ * _loc8_;
         var _loc17_:Number = _loc3_ * _loc9_ - _loc14_ * _loc6_;
         var _loc18_:Number = this.y;
         var _loc19_:Number = -_loc22_ * this.scaleX;
         var _loc20_:Number = _loc26_ * _loc25_;
         var _loc21_:Number = _loc26_ * _loc9_;
         var _loc23_:Number = this.z;
         this.ma = param1.ma * _loc10_ + param1.mb * _loc15_ + param1.mc * _loc19_;
         this.mb = param1.ma * _loc11_ + param1.mb * _loc16_ + param1.mc * _loc20_;
         this.mc = param1.ma * _loc12_ + param1.mb * _loc17_ + param1.mc * _loc21_;
         this.md = param1.ma * _loc13_ + param1.mb * _loc18_ + param1.mc * _loc23_ + param1.md;
         this.me = param1.me * _loc10_ + param1.mf * _loc15_ + param1.mg * _loc19_;
         this.mf = param1.me * _loc11_ + param1.mf * _loc16_ + param1.mg * _loc20_;
         this.mg = param1.me * _loc12_ + param1.mf * _loc17_ + param1.mg * _loc21_;
         this.mh = param1.me * _loc13_ + param1.mf * _loc18_ + param1.mg * _loc23_ + param1.mh;
         this.mi = param1.mi * _loc10_ + param1.mj * _loc15_ + param1.mk * _loc19_;
         this.mj = param1.mi * _loc11_ + param1.mj * _loc16_ + param1.mk * _loc20_;
         this.mk = param1.mi * _loc12_ + param1.mj * _loc17_ + param1.mk * _loc21_;
         this.ml = param1.mi * _loc13_ + param1.mj * _loc18_ + param1.mk * _loc23_ + param1.ml;
      }
      ...
      alternativa3d function cullingInCamera(param1:Camera3D, param2:int) : int
      {
         ...
         var _loc7_:int = param1.numOccluders;
         if(param2 > 0 || _loc7_ > 0)
         {
            ...
            while(_loc4_ != null)
            {
               ...
               _loc10_ = _loc4_.y;
               _loc11_ = _loc4_.z;
               _loc4_.cameraX = this.ma * _loc9_ + this.mb * _loc10_ + this.mc * _loc11_ + this.md;
               _loc4_.cameraY = this.me * _loc9_ + this.mf * _loc10_ + this.mg * _loc11_ + this.mh;
               _loc4_.cameraZ = this.mi * _loc9_ + this.mj * _loc10_ + this.mk * _loc11_ + this.ml;
               _loc4_ = _loc4_.next;
            }
         }
         if(param2 > 0)
         {
            if(param2 & 1)
            {
               _loc12_ = param1.nearClipping;
               _loc4_ = boundVertexList;
               _loc8_ = false;
               _loc13_ = false;
               while(_loc4_ != null)
               {
                  if(_loc4_.cameraZ > _loc12_)
                  {
                     _loc8_ = true;
                     if(_loc13_)
                     {
            ...
            if(param2 & 2)
            {
               _loc6_ = param1.farClipping;
               _loc4_ = boundVertexList;
               _loc8_ = false;
               _loc13_ = false;
               while(_loc4_ != null)
               {
                  if(_loc4_.cameraZ < _loc6_)
                  {
                     _loc8_ = true;
                     if(_loc13_)
                     {
         ...
         if(_loc7_ > 0)
         {
            ...
            while(_loc5_ < _loc7_)
            {
               _loc3_ = param1.occluders[_loc5_];
               while(_loc3_ != null)
               {
                  _loc4_ = boundVertexList;
                  while(_loc4_ != null)
                  {
                     if(_loc3_.cameraX * _loc4_.cameraX + _loc3_.cameraY * _loc4_.cameraY + _loc3_.cameraZ * _loc4_.cameraZ >= 0)
                     {
                        break;
                     }
                     _loc4_ = _loc4_.next;
