package alternativa.engine3d.core
{
   ...
   public class View extends Canvas
   {
      ...
      private static var a3a99653:Device;
      
      private static var a3e88336:Boolean = false;
      
      private static var e50c0fa5:Boolean = false;
      
      private static const mouse:Point = new Point();
      
      private static const f43d6a02:Point = new Point();
      ...
      private static var a430ce4f:Vector.<View> = new Vector.<View>();
      
      private var a4826bec:Boolean = false;
      
      private var ad6a0f2:Point;
      ...
      {
         a1c6e0fe = stage.quality == "low" ? 0 : (stage.quality == "medium" ? 2 : 4);
         stage.addEventListener("keyDown",this.onKeyDown);
         stage.addEventListener("keyUp",this.onKeyUp);
         removeEventListener("addedToStage",this.df55f10);
         addEventListener("removedFromStage",this.c31d85ac);
         if(a3a99653 == null)
         {
            a3a99653 = new Device(stage,"auto",this.constrained ? "baselineConstrained" : "baseline");
         }
         a430ce4f[a430ce4f.length] = this;
         this.device = a3a99653;
      }
      ...
      private function c31d85ac(param1:Event) : void
      {
         ...
         addEventListener("addedToStage",this.df55f10);
         removeEventListener("removedFromStage",this.c31d85ac);
         this.canvas.graphics.clear();
         var _loc2_:int = a430ce4f.indexOf(this);
         while(_loc2_ < a430ce4f.length - 1)
         {
            a430ce4f[_loc2_] = a430ce4f[int(_loc2_ + 1)];
            _loc2_++;
         }
         a430ce4f.pop();
         if(a430ce4f.length == 0)
         {
            a3a99653.dispose();
            a3a99653 = null;
         }
      ...
      alternativa3d function configure() : void
      {
         ...
         var _loc7_:int = int(this.antiAliasEnabled && !this.constrained ? a1c6e0fe : 0);
         this.quality = a1c6e0fe > 0;
         if(!a3e88336)
         {
            _loc3_ = 1000000;
            _loc2_ = 1000000;
            ...
            _loc4_ = -1000000;
            _loc6_ = 0;
            while(_loc6_ < a430ce4f.length)
            {
               _loc1_ = a430ce4f[_loc6_];
               f43d6a02.x = 0;
               f43d6a02.y = 0;
               _loc1_.ad6a0f2 = _loc1_.localToGlobal(f43d6a02);
               if(_loc1_.ad6a0f2.x < _loc3_)
               {
                  _loc3_ = _loc1_.ad6a0f2.x;
               }
               if(_loc1_.ad6a0f2.y < _loc2_)
               {
                  _loc2_ = _loc1_.ad6a0f2.y;
               }
               if(_loc1_.ad6a0f2.x + _loc1_._width > _loc5_)
               {
                  _loc5_ = _loc1_.ad6a0f2.x + _loc1_._width;
               }
               if(_loc1_.ad6a0f2.y + _loc1_._height > _loc4_)
               {
                  _loc4_ = _loc1_.ad6a0f2.y + _loc1_._height;
               }
               _loc6_++;
            }
            this.device.x = _loc3_;
            this.device.y = _loc2_;
            this.device.width = _loc5_ - _loc3_;
            this.device.height = _loc4_ - _loc2_;
            this.device.antiAlias = _loc7_;
            this.device.enableDepthAndStencil = true;
            this.device.enableErrorChecking = this.enableErrorChecking;
            a3e88336 = true;
         }
         if(this.ad6a0f2 == null)
         {
            this.ad6a0f2 = localToGlobal(new Point(0,0));
         }
         this.rect.x = int(this.ad6a0f2.x) - this.device.x;
         this.rect.y = int(this.ad6a0f2.y) - this.device.y;
      ...
      alternativa3d function present() : void
      {
         ...
         this.correction = false;
         var _loc2_:int = 0;
         while(_loc2_ < a430ce4f.length)
         {
            _loc1_ = a430ce4f[_loc2_];
            if(!_loc1_.a4826bec)
            {
               break;
            }
            ...
            if(_loc2_ != null)
            {
               if(_loc9_ != null)
               {
                  ...
                  while(_loc3_ != null)
                  {
                     ...
                     if(_loc6_ == null && Boolean(_loc3_.mouseEnabled))
                     {
                        _loc6_ = _loc3_;
                     }
