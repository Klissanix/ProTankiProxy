package alternativa.engine3d.core
{
   ...
   public class Vertex
   {
      ...
      {
         return "[Vertex " + this.x.toFixed(2) + ", " + this.y.toFixed(2) + ", " + this.z.toFixed(2) + ", " + this.u.toFixed(3) + ", " + this.v.toFixed(3) + "]";
      }
   }
}
