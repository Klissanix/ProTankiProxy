package alternativa.engine3d.materials
{
   ...
   public class TextureMaterialFragmentShader extends FragmentShader
   {
      ...
      public function TextureMaterialFragmentShader(param1:Boolean, param2:Boolean, param3:Boolean, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:Boolean, param13:Boolean, param14:Boolean, param15:Boolean, param16:Boolean, param17:Boolean, param18:Boolean, param19:Boolean, param20:Boolean)
      {
         ...
         {
            _loc21_ = param1 ? SamplerRepeat.WRAP : SamplerRepeat.CLAMP;
            _loc22_ = param2 ? SamplerFilter.LINEAR : SamplerFilter.NEAREST;
            _loc23_ = param3 ? (param2 ? SamplerMipMap.LINEAR : SamplerMipMap.NEAREST) : SamplerMipMap.NONE;
            _loc25_ = param4 ? (param5 ? SamplerType.DXT5 : SamplerType.DXT1) : SamplerType.RGBA;
            tex(ft0,v0,fs0.dim(SamplerDim.D2).repeat(_loc21_).filter(_loc22_).mipmap(_loc23_).type(_loc25_));
         }
         if(param6)
         {
            sub(ft1.w,ft0,fc[14]);
