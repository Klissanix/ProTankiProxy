package alternativa.engine3d.loaders
{
   ...
   public class Parser3DS
   {
      ...
      private static const b33c3eb9:int = 6;
      ...
      private function b270d396(param1:int, param2:int) : void
      {
         ...
         {
            case 0:
               this.c4781040(_loc3_.dataPosition,_loc3_.size - 6);
         }
      ...
      private function c4781040(param1:int, param2:int) : void
      {
         ...
         switch(_loc3_.id)
         {
            case 2:
               break;
            case 15677:
               this.f3b99b8d(_loc3_.dataPosition,_loc3_.size - 6);
               break;
            case 45056:
               this.e12054c3(_loc3_.dataPosition,_loc3_.size - 6);
         }
         ...
         while(param2 >= 6)
         {
            ...
            switch(_loc3_.id)
            {
               case 45055:
                  ...
                  this.e290e7d8(_loc4_,_loc3_.dataPosition,_loc3_.size - 6);
                  break;
               case 16384:
                  this.b366ff1(_loc3_);
            }
      ...
      private function b366ff1(param1:ChunkInfo) : void
      {
         ...
         this.e9c63dd(_loc3_,param1.dataPosition + _loc2_,param1.size - 6 - _loc2_);
      }
      ...
      private function e9c63dd(param1:ObjectData, param2:int, param3:int) : void
      {
         ...
         {
            case 16640:
               this.f2535688(param1,_loc4_.dataPosition,_loc4_.size - 6);
               break;
            case 17920:
            case 18176:
         }
      ...
      private function a6cddd05(param1:ObjectData, param2:ChunkInfo) : void
      {
         ...
         this.b33ba982(param1,param2.dataPosition + _loc3_,param2.size - 6 - _loc3_);
      }
      ...
      private function f187b396(param1:ObjectData) : void
      {
         ...
         var _loc4_:String = this.getString(this.data.position);
         var _loc2_:int = int(this.data.readUnsignedShort());
         var _loc5_:Vector.<int> = new Vector.<int>(_loc2_);
         param1.surfaces[_loc4_] = _loc5_;
         while(_loc3_ < _loc2_)
         {
            _loc5_[_loc3_] = this.data.readUnsignedShort();
            _loc3_++;
         }
      }
         ...
         while(param2 >= 6)
         {
            ...
            switch(_loc3_.id - 45057)
            {
               ...
               case 6:
                  ...
                  this.f2b12cd4[f2b12cd4.length] = _loc4_;
                  this.e65e96f3(_loc4_,_loc3_.dataPosition,_loc3_.size - 6);
            }
      ...
      private function e290e7d8(param1:MaterialData, param2:int, param3:int) : void
      {
         ...
         switch((_loc4_ = this.c31f8921(param2)).id)
         {
            ...
            case 41472:
               ...
               this.a5d5f984(param1.name,param1.diffuseMap,_loc4_.dataPosition,_loc4_.size - 6);
               break;
            case 41786:
               break;
            case 41488:
               param1.opacityMap = new MapData();
               this.a5d5f984(param1.name,param1.opacityMap,_loc4_.dataPosition,_loc4_.size - 6);
               break;
            case 41520:
            case 41788:
            case 41476:
      ...
      private function cfc8937(param1:String, param2:Number) : void
      {
         ...
         for(var _loc16_ in this.f5f52b33)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               this.textureMaterials[textureMaterials.length] = _loc4_;
            }
            else
            {
            ...
            this.materials[materials.length] = _loc11_.material;
         }
         if(this.f2b12cd4 != null)
         {
            if(this.d39eb057 != null)
            {
               ...
               {
                  _loc8_ = this.f2b12cd4[_loc6_];
                  this.objects[objects.length] = _loc8_.object;
                  this.parents[parents.length] = _loc8_.parentIndex == 65535 ? null : AnimationData(this.f2b12cd4[_loc8_.parentIndex]).object;
                  _loc6_++;
               }
            }
         }
         else
         {
            for(_loc15_ in this.d39eb057)
            {
               ...
               if(_loc18_.vertices != null)
               {
                  ...
                  this.objects[objects.length] = _loc20_;
                  this.parents[parents.length] = null;
               }
            }
         }
      }
      ...
      private function f9a385d(param1:Mesh, param2:ObjectData, param3:AnimationData, param4:Number) : void
      {
         ...
         var _loc37_:Vector.<Face> = new Vector.<Face>();
         if(param3 != null)
         {
            _loc12_ = param2.a;
            _loc14_ = param2.b;
            ...
            _loc23_ = param2.k;
            _loc24_ = param2.l;
            _loc27_ = 1 / (-_loc15_ * _loc18_ * _loc21_ + _loc14_ * _loc19_ * _loc21_ + _loc15_ * _loc17_ * _loc22_ - _loc12_ * _loc19_ * _loc22_ - _loc14_ * _loc17_ * _loc23_ + _loc12_ * _loc18_ * _loc23_);
            param2.a = (-_loc19_ * _loc22_ + _loc18_ * _loc23_) * _loc27_;
            param2.b = (_loc15_ * _loc22_ - _loc14_ * _loc23_) * _loc27_;
            param2.c = (-_loc15_ * _loc18_ + _loc14_ * _loc19_) * _loc27_;
            param2.d = (_loc16_ * _loc19_ * _loc22_ - _loc15_ * _loc20_ * _loc22_ - _loc16_ * _loc18_ * _loc23_ + _loc14_ * _loc20_ * _loc23_ + _loc15_ * _loc18_ * _loc24_ - _loc14_ * _loc19_ * _loc24_) * _loc27_;
            param2.e = (_loc19_ * _loc21_ - _loc17_ * _loc23_) * _loc27_;
            param2.f = (-_loc15_ * _loc21_ + _loc12_ * _loc23_) * _loc27_;
            param2.g = (_loc15_ * _loc17_ - _loc12_ * _loc19_) * _loc27_;
            param2.h = (_loc15_ * _loc20_ * _loc21_ - _loc16_ * _loc19_ * _loc21_ + _loc16_ * _loc17_ * _loc23_ - _loc12_ * _loc20_ * _loc23_ - _loc15_ * _loc17_ * _loc24_ + _loc12_ * _loc19_ * _loc24_) * _loc27_;
            param2.i = (-_loc18_ * _loc21_ + _loc17_ * _loc22_) * _loc27_;
            param2.j = (_loc14_ * _loc21_ - _loc12_ * _loc22_) * _loc27_;
            param2.k = (-_loc14_ * _loc17_ + _loc12_ * _loc18_) * _loc27_;
            param2.l = (_loc16_ * _loc18_ * _loc21_ - _loc14_ * _loc20_ * _loc21_ - _loc16_ * _loc17_ * _loc22_ + _loc12_ * _loc20_ * _loc22_ + _loc14_ * _loc17_ * _loc24_ - _loc12_ * _loc18_ * _loc24_) * _loc27_;
         ...
         if(param2.vertices != null)
         {
            ...
            while(_loc8_ < _loc9_)
            {
               ...
               if(_loc10_)
               {
                  _loc34_ = param2.vertices[_loc8_++];
                  _loc35_ = param2.vertices[_loc8_++];
                  _loc36_ = param2.vertices[_loc8_++];
                  _loc6_.x = param2.a * _loc34_ + param2.b * _loc35_ + param2.c * _loc36_ + param2.d;
                  _loc6_.y = param2.e * _loc34_ + param2.f * _loc35_ + param2.g * _loc36_ + param2.h;
                  _loc6_.z = param2.i * _loc34_ + param2.j * _loc35_ + param2.k * _loc36_ + param2.l;
               }
               else
               {
               ...
               if(_loc13_)
               {
                  _loc6_.u = param2.uvs[_loc32_++];
                  _loc6_.v = 1 - param2.uvs[_loc32_++];
               }
               _loc6_.transformId = -1;
               _loc7_[_loc31_++] = _loc6_;
         ...
         if(param2.faces != null)
         {
            ...
            {
               _loc26_ = new Face();
               _loc26_.wrapper = new Wrapper();
               _loc26_.wrapper.next = new Wrapper();
               _loc26_.wrapper.next.next = new Wrapper();
               _loc26_.wrapper.vertex = _loc7_[param2.faces[_loc8_++]];
               _loc26_.wrapper.next.vertex = _loc7_[param2.faces[_loc8_++]];
               _loc26_.wrapper.next.next.vertex = _loc7_[param2.faces[_loc8_++]];
               _loc26_.smoothingGroups = param2.smoothingGroups[_loc32_++];
               _loc37_[_loc32_ - 1] = _loc26_;
               if(_loc5_ != null)
               {
                  _loc5_.next = _loc26_;
               }
         ...
         if(param2.surfaces != null)
         {
            ...
            {
               _loc38_ = param2.surfaces[_loc11_];
               _loc25_ = this.f5f52b33[_loc11_];
               _loc28_ = _loc25_.material;
               _loc8_ = 0;
               while(_loc8_ < _loc38_.length)
               {
                  _loc26_ = _loc37_[_loc38_[_loc8_]];
                  _loc26_.material = _loc28_;
                  if(_loc25_.matrix != null)
                  {
                     _loc33_ = _loc26_.wrapper;
                     while(_loc33_ != null)
                     {
                        _loc6_ = _loc33_.vertex;
                        if(_loc6_.transformId < 0)
                        {
                           _loc29_ = _loc6_.u;
                           _loc30_ = _loc6_.v;
                           _loc6_.u = _loc25_.matrix.a * _loc29_ + _loc25_.matrix.b * _loc30_ + _loc25_.matrix.tx;
                           _loc6_.v = _loc25_.matrix.c * _loc29_ + _loc25_.matrix.d * _loc30_ + _loc25_.matrix.ty;
