package alternativa.engine3d.objects
{
   ...
   public class Mesh extends Object3D
   {
      ...
      public static function calculateVerticesNormalsBySmoothingGroupsForMeshList(param1:Vector.<Object3D>, param2:Number = 0) : void
      {
         ...
         while(_loc5_ < _loc7_)
         {
            _loc19_ = param1[_loc5_] as Mesh;
            if(_loc19_ != null)
            {
               _loc19_.deleteResources();
               _loc19_.composeMatrix();
               _loc13_ = _loc19_;
               while(_loc13_._parent != null)
               {
                  _loc13_ = _loc13_._parent;
                  _loc13_.composeMatrix();
                  _loc19_.appendMatrix(_loc13_);
               }
               _loc4_ = _loc19_.vertexList;
               while(_loc4_ != null)
               {
                  _loc14_ = _loc4_.x;
                  _loc15_ = _loc4_.y;
                  _loc16_ = _loc4_.z;
                  _loc4_.x = _loc19_.ma * _loc14_ + _loc19_.mb * _loc15_ + _loc19_.mc * _loc16_ + _loc19_.md;
                  _loc4_.y = _loc19_.me * _loc14_ + _loc19_.mf * _loc15_ + _loc19_.mg * _loc16_ + _loc19_.mh;
                  _loc4_.z = _loc19_.mi * _loc14_ + _loc19_.mj * _loc15_ + _loc19_.mk * _loc16_ + _loc19_.ml;
                  _loc4_ = _loc4_.next;
               }
               _loc19_.f23ef255();
               _loc10_ = _loc19_.faceList;
               while(_loc10_ != null)
               {
                  if(_loc10_.smoothingGroups > 0)
                  {
                     _loc6_ = _loc10_.wrapper;
                     while(_loc6_ != null)
                     {
                        _loc4_ = _loc6_.vertex;
                        if(!_loc17_[_loc4_])
                        {
                           _loc17_[_loc4_] = new Dictionary();
                        }
                        _loc17_[_loc4_][_loc10_] = true;
                        _loc6_ = _loc6_.next;
                     }
                  }
         ...
         {
            _loc9_[_loc3_] = _loc18_;
            _loc3_++;
         }
         if(_loc3_ > 0)
         {
            f2d8ae73(_loc9_,0,_loc3_,0,param2,new Vector.<int>(),_loc17_);
         }
         _loc5_ = 0;
         while(_loc5_ < _loc7_)
         {
            ...
            if(_loc19_ != null)
            {
               ...
               while(_loc10_ != null)
               {
                  ...
                  while(_loc6_ != null)
                  {
                     ...
                     if(_loc10_.smoothingGroups > 0)
                     {
                        for(_loc18_ in _loc17_[_loc4_])
                        {
                           _loc8_ = _loc18_;
                           if(_loc10_ != _loc8_ && (_loc10_.smoothingGroups & _loc8_.smoothingGroups) > 0)
                           {
                              _loc11_.normalX += _loc8_.normalX;
                              _loc11_.normalY += _loc8_.normalY;
                              _loc11_.normalZ += _loc8_.normalZ;
                           }
                        }
                        _loc12_ = _loc11_.normalX * _loc11_.normalX + _loc11_.normalY * _loc11_.normalY + _loc11_.normalZ * _loc11_.normalZ;
                        if(_loc12_ > 0.001)
                        {
                           _loc12_ = 1 / Math.sqrt(_loc12_);
                           _loc11_.normalX *= _loc12_;
                           _loc11_.normalY *= _loc12_;
                           _loc11_.normalZ *= _loc12_;
                        }
                     }
                     _loc6_.vertex = _loc11_;
                     _loc11_.next = _loc19_.vertexList;
                     _loc19_.vertexList = _loc11_;
                     _loc6_ = _loc6_.next;
                  }
                  _loc10_ = _loc10_.next;
               }
         ...
         while(_loc5_ < _loc7_)
         {
            ...
            if(_loc19_ != null)
            {
               ...
               while(_loc4_ != null)
               {
                  ...
                  _loc4_.y = _loc19_.me * _loc14_ + _loc19_.mf * _loc15_ + _loc19_.mg * _loc16_ + _loc19_.mh;
                  _loc4_.z = _loc19_.mi * _loc14_ + _loc19_.mj * _loc15_ + _loc19_.mk * _loc16_ + _loc19_.ml;
                  _loc14_ = _loc4_.normalX;
                  _loc15_ = _loc4_.normalY;
                  _loc16_ = _loc4_.normalZ;
                  _loc4_.normalX = _loc19_.ma * _loc14_ + _loc19_.mb * _loc15_ + _loc19_.mc * _loc16_;
                  _loc4_.normalY = _loc19_.me * _loc14_ + _loc19_.mf * _loc15_ + _loc19_.mg * _loc16_;
                  _loc4_.normalZ = _loc19_.mi * _loc14_ + _loc19_.mj * _loc15_ + _loc19_.mk * _loc16_;
                  _loc4_ = _loc4_.next;
               }
               _loc10_ = _loc19_.faceList;
               while(_loc10_ != null)
               {
                  _loc14_ = _loc10_.normalX;
                  _loc15_ = _loc10_.normalY;
                  _loc16_ = _loc10_.normalZ;
                  _loc10_.normalX = _loc19_.ma * _loc14_ + _loc19_.mb * _loc15_ + _loc19_.mc * _loc16_;
                  _loc10_.normalY = _loc19_.me * _loc14_ + _loc19_.mf * _loc15_ + _loc19_.mg * _loc16_;
                  _loc10_.normalZ = _loc19_.mi * _loc14_ + _loc19_.mj * _loc15_ + _loc19_.mk * _loc16_;
                  _loc10_.offset = _loc10_.wrapper.vertex.x * _loc10_.normalX + _loc10_.wrapper.vertex.y * _loc10_.normalY + _loc10_.wrapper.vertex.z * _loc10_.normalZ;
                  _loc10_ = _loc10_.next;
               }
            }
            _loc5_++;
      ...
      private static function f2d8ae73(param1:Vector.<Vertex>, param2:int, param3:int, param4:int, param5:Number, param6:Vector.<int>, param7:Dictionary) : void
      {
         var _loc11_:int = 0;
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         ...
         {
            _loc12_--;
            _loc13_ = _loc17_ = param6[_loc12_];
            _loc12_--;
            _loc11_ = _loc16_ = param6[_loc12_];
            _loc8_ = param1[_loc17_ + _loc16_ >> 1];
            _loc10_ = _loc8_.offset;
            while(_loc11_ <= _loc13_)
            {
               _loc18_ = param1[_loc11_];
               while(_loc18_.offset > _loc10_)
               {
                  _loc11_++;
                  _loc18_ = param1[_loc11_];
               }
               _loc15_ = param1[_loc13_];
               while(_loc15_.offset < _loc10_)
               {
                  _loc13_--;
                  _loc15_ = param1[_loc13_];
               }
            ...
            if(_loc16_ < _loc13_)
            {
               param6[_loc12_] = _loc16_;
               _loc12_++;
               param6[_loc12_] = _loc13_;
               _loc12_++;
            }
            if(_loc11_ < _loc17_)
            {
               param6[_loc12_] = _loc11_;
               _loc12_++;
               param6[_loc12_] = _loc17_;
               _loc12_++;
            }
         }
         _loc11_ = param2;
         ...
         while(_loc13_ <= param3)
         {
            if(_loc13_ < param3)
            {
               _loc19_ = param1[_loc13_];
            }
            if(_loc13_ == param3 || _loc8_.offset - _loc19_.offset > param5)
            {
               if(_loc13_ - _loc11_ > 1)
               {
                  if(param4 < 2)
                  {
                     f2d8ae73(param1,_loc11_,_loc13_,param4 + 1,param5,param6,param7);
                  }
                  else
                  {
                     _loc14_ = _loc11_ + 1;
                     ...
                     {
                        _loc19_ = param1[_loc14_];
                        for(_loc9_ in param7[_loc19_])
                        {
                           param7[_loc8_][_loc9_] = true;
                        }
                        _loc14_++;
                     }
                     _loc14_ = _loc11_ + 1;
                     ...
                     {
                        _loc19_ = param1[_loc14_];
                        for(_loc9_ in param7[_loc8_])
                        {
                           param7[_loc19_][_loc9_] = true;
                        }
                        _loc14_++;
                     }
                  }
      ...
      public function calculateVerticesNormalsByAngle(param1:Number, param2:Number = 0) : void
      {
         ...
         while(_loc3_ != null)
         {
            ...
            while(_loc7_ != null)
            {
               ...
               _loc10_[_loc6_][_loc3_] = true;
               _loc7_ = _loc7_.next;
            }
            _loc3_ = _loc3_.next;
         }
         var _loc9_:Vector.<Vertex> = this.vertices;
         f2d8ae73(_loc9_,0,_loc9_.length,0,param2,new Vector.<int>(),_loc10_);
         this.vertexList = null;
         ...
         while(_loc3_ != null)
         {
            ...
            while(_loc7_ != null)
            {
               ...
               _loc4_.u = _loc6_.u;
               _loc4_.v = _loc6_.v;
               _loc4_.normalX = _loc3_.normalX;
               _loc4_.normalY = _loc3_.normalY;
               _loc4_.normalZ = _loc3_.normalZ;
               for(_loc11_ in _loc10_[_loc6_])
               {
                  _loc8_ = _loc11_;
                  if(_loc3_ != _loc8_ && _loc3_.normalX * _loc8_.normalX + _loc3_.normalY * _loc8_.normalY + _loc3_.normalZ * _loc8_.normalZ >= param1)
                  {
                     _loc4_.normalX += _loc8_.normalX;
                     _loc4_.normalY += _loc8_.normalY;
                     _loc4_.normalZ += _loc8_.normalZ;
                  }
               }
               _loc5_ = _loc4_.normalX * _loc4_.normalX + _loc4_.normalY * _loc4_.normalY + _loc4_.normalZ * _loc4_.normalZ;
               if(_loc5_ > 0.001)
               {
                  _loc5_ = 1 / Math.sqrt(_loc5_);
                  _loc4_.normalX *= _loc5_;
                  _loc4_.normalY *= _loc5_;
                  _loc4_.normalZ *= _loc5_;
               }
               _loc7_.vertex = _loc4_;
               _loc4_.next = this.vertexList;
               this.vertexList = _loc4_;
               _loc7_ = _loc7_.next;
            }
            _loc3_ = _loc3_.next;
         }
      ...
      public function calculateVerticesNormalsBySmoothingGroups(param1:Number = 0) : void
      {
         ...
         if(_loc5_ > 0)
         {
            f2d8ae73(_loc9_,0,_loc5_,0,param1,new Vector.<int>(),_loc10_);
         }
         this.vertexList = null;
         _loc2_ = this.faceList;
         while(_loc2_ != null)
         {
            ...
            while(_loc7_ != null)
            {
               ...
               _loc3_.u = _loc6_.u;
               _loc3_.v = _loc6_.v;
               _loc3_.normalX = _loc2_.normalX;
               _loc3_.normalY = _loc2_.normalY;
               _loc3_.normalZ = _loc2_.normalZ;
               if(_loc2_.smoothingGroups > 0)
               {
                  for(_loc11_ in _loc10_[_loc6_])
                  {
                     _loc8_ = _loc11_;
                     if(_loc2_ != _loc8_ && (_loc2_.smoothingGroups & _loc8_.smoothingGroups) > 0)
                     {
                        _loc3_.normalX += _loc8_.normalX;
                        _loc3_.normalY += _loc8_.normalY;
                        _loc3_.normalZ += _loc8_.normalZ;
                     }
                  }
      ...
      private function f23ef255() : void
      {
         ...
         while(_loc8_ != null)
         {
            ...
            _loc2_ = _loc10_.vertex;
            _loc10_ = _loc10_.next;
            _loc3_ = _loc10_.vertex;
            _loc10_ = _loc10_.next;
            _loc4_ = _loc10_.vertex;
            _loc13_ = _loc3_.x - _loc2_.x;
            _loc9_ = _loc3_.y - _loc2_.y;
            _loc7_ = _loc3_.z - _loc2_.z;
            _loc11_ = _loc4_.x - _loc2_.x;
            _loc12_ = _loc4_.y - _loc2_.y;
            _loc5_ = _loc4_.z - _loc2_.z;
            _loc8_.normalX = _loc5_ * _loc9_ - _loc12_ * _loc7_;
            _loc8_.normalY = _loc11_ * _loc7_ - _loc5_ * _loc13_;
            _loc8_.normalZ = _loc12_ * _loc13_ - _loc11_ * _loc9_;
            _loc6_ = _loc8_.normalX * _loc8_.normalX + _loc8_.normalY * _loc8_.normalY + _loc8_.normalZ * _loc8_.normalZ;
            if(_loc6_ > 0.001)
            {
               _loc6_ = 1 / Math.sqrt(_loc6_);
               _loc8_.normalX *= _loc6_;
               _loc8_.normalY *= _loc6_;
               _loc8_.normalZ *= _loc6_;
               _loc8_.offset = _loc2_.x * _loc8_.normalX + _loc2_.y * _loc8_.normalY + _loc2_.z * _loc8_.normalZ;
               _loc8_.next = this.faceList;
      ...
      override public function intersectRay(param1:Vector3D, param2:Vector3D, param3:Dictionary = null, param4:Camera3D = null) : RayIntersectionData
      {
         ...
         var _loc31_:RayIntersectionData = null;
         ...
         var _loc26_:Number = param1.z;
         var _loc21_:Number = param2.x;
         var _loc14_:Number = param2.y;
         var _loc15_:Number = param2.z;
         ...
         while(_loc28_ != null)
         {
            ...
            _loc9_ = _loc21_ * _loc5_ + _loc14_ * _loc6_ + _loc15_ * _loc7_;
            if(_loc9_ < 0)
            {
               _loc22_ = _loc24_ * _loc5_ + _loc25_ * _loc6_ + _loc26_ * _loc7_ - _loc28_.offset;
               if(_loc22_ > 0)
               {
                  _loc32_ = -_loc22_ / _loc9_;
                  if(_loc13_ == null || _loc32_ < _loc30_)
                  {
                     _loc16_ = _loc24_ + _loc21_ * _loc32_;
                     _loc8_ = _loc25_ + _loc14_ * _loc32_;
                     _loc12_ = _loc26_ + _loc15_ * _loc32_;
                     ...
                     while(_loc10_ != null)
                     {
                        ...
                        _loc27_ = _loc20_.z - _loc19_.z;
                        _loc17_ = _loc16_ - _loc19_.x;
                        _loc33_ = _loc8_ - _loc19_.y;
                        _loc23_ = _loc12_ - _loc19_.z;
                        if((_loc23_ * _loc29_ - _loc33_ * _loc27_) * _loc5_ + (_loc17_ * _loc27_ - _loc23_ * _loc18_) * _loc6_ + (_loc33_ * _loc18_ - _loc17_ * _loc29_) * _loc7_ < 0)
                        {
                           break;
                        }
                        _loc10_ = _loc10_.next;
         ...
         if(_loc13_ != null)
         {
            _loc31_ = new RayIntersectionData();
            _loc31_.object = this;
            _loc31_.face = _loc11_;
            _loc31_.point = _loc13_;
            _loc31_.time = _loc30_;
            return _loc31_;
         }
         return null;
      }
      ...
      override alternativa3d function draw(param1:Camera3D) : void
      {
         ...
         _loc4_ = this.prepareFaces(param1,_loc4_);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc4_.processNext != null)
         {
            if(this.sorting == 1)
            {
               _loc4_ = param1.sortByAverageZ(_loc4_);
            }
            else if(this.sorting == 2)
            {
               _loc4_ = param1.sortByDynamicBSP(_loc4_,this.threshold);
            }
         }
         if(_loc2_ & 0x10)
         {
      ...
      override alternativa3d function getVG(param1:Camera3D) : VG
      {
         ...
         return VG.create(this,_loc4_,this.sorting,_loc2_,false);
      }
      ...
      alternativa3d function prepareResources() : void
      {
         ...
         if(this.vertexBuffer == null)
         {
            ...
            while(_loc7_ != null)
            {
               _loc10_[_loc12_] = _loc7_.x;
               _loc12_++;
               _loc10_[_loc12_] = _loc7_.y;
               _loc12_++;
               _loc10_[_loc12_] = _loc7_.z;
               _loc12_++;
               _loc10_[_loc12_] = _loc7_.u;
               _loc12_++;
               _loc10_[_loc12_] = _loc7_.v;
               _loc12_++;
               _loc10_[_loc12_] = _loc7_.normalX;
               _loc12_++;
               _loc10_[_loc12_] = _loc7_.normalY;
               _loc12_++;
               _loc10_[_loc12_] = _loc7_.normalZ;
               _loc12_++;
               _loc7_.index = _loc13_;
               _loc13_++;
               _loc7_ = _loc7_.next;
            }
            if(_loc13_ > 0)
            ...
            _loc14_ = this.faceList;
            while(_loc14_ != null)
            {
               _loc1_ = _loc14_.next;
               _loc14_.next = null;
               if(_loc14_.material != null && (!_loc14_.material.transparent || _loc14_.material.alphaTestThreshold > 0))
               {
                  _loc14_.next = _loc15_[_loc14_.material];
                  _loc15_[_loc14_.material] = _loc14_;
               }
               else
               {
                  if(_loc6_ != null)
                  ...
                  {
                     this.ab6acaf = _loc14_;
                  }
                  _loc6_ = _loc14_;
               }
               _loc14_ = _loc1_;
            }
            this.faceList = this.ab6acaf;
            _loc9_ = new Vector.<uint>();
            _loc2_ = 0;
            for(var _loc16_ in _loc15_)
            {
               _loc11_ = _loc15_[_loc16_];
               this.opaqueMaterials[this.opaqueLength] = _loc11_.material;
               this.opaqueBegins[this.opaqueLength] = this.numTriangles * 3;
               _loc14_ = _loc11_;
               while(_loc14_ != null)
               {
                  _loc8_ = _loc14_.wrapper;
                  _loc3_ = _loc8_.vertex.index;
                  _loc8_ = _loc8_.next;
                  _loc4_ = _loc8_.vertex.index;
                  _loc8_ = _loc8_.next;
                  while(_loc8_ != null)
                  {
                     _loc5_ = _loc8_.vertex.index;
               ...
               this.opaqueLength++;
               _loc6_.next = this.faceList;
               this.faceList = _loc11_;
            }
            _loc14_ = this.ab6acaf;
            while(_loc14_ != null)
            {
               _loc8_ = _loc14_.wrapper;
               _loc3_ = _loc8_.vertex.index;
            ...
            if(_loc2_ > 0)
            {
               this.indexBuffer = new IndexBufferResource(_loc9_);
            }
         }
      }
      ...
      alternativa3d function prepareFaces(param1:Camera3D, param2:Face) : Face
      {
         ...
         var _loc8_:Number = NaN;
         var _loc10_:Number = NaN;
         var _loc3_:Face = param2;
         while(_loc3_ != null)
         {
            if(_loc3_.normalX * imd + _loc3_.normalY * imh + _loc3_.normalZ * iml > _loc3_.offset)
            {
               _loc9_ = _loc3_.wrapper;
               while(_loc9_ != null)
               {
                  _loc5_ = _loc9_.vertex;
                  if(_loc5_.transformId != transformId)
                  {
                     _loc7_ = _loc5_.x;
                     _loc8_ = _loc5_.y;
                     _loc10_ = _loc5_.z;
                     _loc5_.cameraX = ma * _loc7_ + mb * _loc8_ + mc * _loc10_ + md;
                     _loc5_.cameraY = me * _loc7_ + mf * _loc8_ + mg * _loc10_ + mh;
                     _loc5_.cameraZ = mi * _loc7_ + mj * _loc8_ + mk * _loc10_ + ml;
      ...
      alternativa3d function drawFaces(param1:Camera3D, param2:Face) : void
      {
         ...
         var _loc4_:Face = param2;
         while(_loc4_ != null)
         {
            _loc3_ = _loc4_.processNext;
            if(_loc3_ == null || _loc3_.material != param2.material)
            {
               _loc4_.processNext = null;
               if(param2.material != null)
               {
                  param2.processNegative = _loc5_;
                  _loc5_ = param2;
               }
               else
               {
      ...
      override alternativa3d function split(param1:Vector3D, param2:Vector3D, param3:Vector3D, param4:Number) : Vector.<Object3D>
      {
         ...
         var _loc5_:Vector3D = calculatePlane(param1,param2,param3);
         var _loc26_:Number = _loc5_.w - param4;
         var _loc12_:Number = _loc5_.w + param4;
         var _loc21_:Vertex = this.vertexList;
         while(_loc21_ != null)
         {
            _loc18_ = _loc21_.next;
            _loc21_.next = null;
            _loc21_.offset = _loc21_.x * _loc5_.x + _loc21_.y * _loc5_.y + _loc21_.z * _loc5_.z;
            if(_loc21_.offset >= _loc26_ && _loc21_.offset <= _loc12_)
            {
         ...
         while(_loc17_ != null)
         {
            ...
            _loc29_ = _loc13_.offset < _loc26_ || _loc11_.offset < _loc26_ || _loc15_.offset < _loc26_;
            _loc19_ = _loc13_.offset > _loc12_ || _loc11_.offset > _loc12_ || _loc15_.offset > _loc12_;
            _loc23_ = _loc23_.next;
            while(_loc23_ != null)
            {
               _loc21_ = _loc23_.vertex;
               if(_loc21_.offset < _loc26_)
               {
                  _loc29_ = true;
               }
            ...
            else
            {
               ...
               {
                  _loc11_ = _loc23_.vertex;
                  if(_loc13_.offset < _loc26_ && _loc11_.offset > _loc12_ || _loc13_.offset > _loc12_ && _loc11_.offset < _loc26_)
                  {
                     _loc20_ = (_loc5_.w - _loc13_.offset) / (_loc11_.offset - _loc13_.offset);
                     _loc21_ = new Vertex();
                     ...
                     _loc27_ = new Wrapper();
                     _loc27_.vertex = _loc21_;
                     if(_loc24_ != null)
                     {
                        _loc24_.next = _loc27_;
                     }
                     else
                     {
                        _loc8_.wrapper = _loc27_;
                     }
                     _loc24_ = _loc27_;
                     _loc28_ = new Vertex();
                     _loc28_.x = _loc21_.x;
                     ...
                     {
                        _loc14_.wrapper = _loc27_;
                     }
                     _loc9_ = _loc27_;
                  }
                  if(_loc11_.offset < _loc26_)
                  {
                     _loc27_ = _loc23_.create();
                     _loc27_.vertex = _loc11_;
                     if(_loc24_ != null)
                     {
                        _loc24_.next = _loc27_;
                     }
