package alternativa.engine3d.lights
{
   ...
   public class OmniLight extends Light3D
   {
      ...
      override alternativa3d function drawDebug(param1:Camera3D) : void
      {
         ...
         if(_loc4_ > 0)
         {
            _loc2_ = param1.view.canvas;
            if(_loc4_ & 0x0100 && ml > param1.nearClipping)
            {
               _loc10_ = (color >> 16 & 0xFF) * intensity;
               _loc5_ = (color >> 8 & 0xFF) * intensity;
               _loc3_ = (color & 0xFF) * intensity;
               _loc7_ = ((_loc10_ > 255 ? 255 : _loc10_) << 16) + ((_loc5_ > 255 ? 255 : _loc5_) << 8) + (_loc3_ > 255 ? 255 : _loc3_);
               _loc8_ = ma * param1.viewSizeX / param1.focalLength;
               _loc9_ = me * param1.viewSizeY / param1.focalLength;
               _loc6_ = Math.sqrt(_loc8_ * _loc8_ + _loc9_ * _loc9_ + mi * mi);
               _loc8_ = mb * param1.viewSizeX / param1.focalLength;
               _loc9_ = mf * param1.viewSizeY / param1.focalLength;
               _loc6_ += Math.sqrt(_loc8_ * _loc8_ + _loc9_ * _loc9_ + mj * mj);
               _loc8_ = mc * param1.viewSizeX / param1.focalLength;
               _loc9_ = mg * param1.viewSizeY / param1.focalLength;
               _loc6_ += Math.sqrt(_loc8_ * _loc8_ + _loc9_ * _loc9_ + mk * mk);
               _loc6_ = _loc6_ / 3;
               _loc12_ = Math.round(md * param1.viewSizeX / ml);
               _loc13_ = Math.round(mh * param1.viewSizeY / ml);
               _loc11_ = 8;
               _loc2_.graphics.lineStyle(1,_loc7_);
               _loc2_.graphics.moveTo(_loc12_ - _loc11_,_loc13_);
               _loc2_.graphics.lineTo(_loc12_ + _loc11_,_loc13_);
               _loc2_.graphics.moveTo(_loc12_,_loc13_ - _loc11_);
               _loc2_.graphics.lineTo(_loc12_,_loc13_ + _loc11_);
               _loc2_.graphics.moveTo(_loc12_ - _loc11_ * 0.7,_loc13_ - _loc11_ * 0.7);
               _loc2_.graphics.lineTo(_loc12_ + _loc11_ * 0.7,_loc13_ + _loc11_ * 0.7);
               _loc2_.graphics.moveTo(_loc12_ - _loc11_ * 0.7,_loc13_ + _loc11_ * 0.7);
               _loc2_.graphics.lineTo(_loc12_ + _loc11_ * 0.7,_loc13_ - _loc11_ * 0.7);
               _loc2_.graphics.drawCircle(_loc12_,_loc13_,this.attenuationBegin * _loc6_ * param1.focalLength / ml);
               _loc2_.graphics.lineStyle(1,_loc7_,0.5);
               _loc2_.graphics.drawCircle(_loc12_,_loc13_,this.attenuationEnd * _loc6_ * param1.focalLength / ml);
            }
            if(_loc4_ & 8)
            {
