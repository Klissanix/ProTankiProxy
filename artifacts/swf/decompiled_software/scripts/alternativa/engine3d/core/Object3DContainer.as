package alternativa.engine3d.core
{
   ...
   public class Object3DContainer extends Object3D
   {
      ...
      override alternativa3d function draw(param1:Camera3D, param2:Canvas) : void
      {
         ...
         while(_loc5_ != null)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  this.visibleChildren[this.numVisibleChildren] = _loc5_;
         ...
         {
            if(param1.debug && (_loc4_ = param1.checkInDebug(this)) > 0)
            {
            ...
            _loc3_.numDraws = 0;
            this.drawVisibleChildren(param1,_loc3_);
      ...
      {
         var _loc4_:Object3D = null;
         var _loc3_:int = this.numVisibleChildren - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.visibleChildren[_loc3_];
            _loc4_.draw(param1,param2);
            this.visibleChildren[_loc3_] = null;
            _loc3_--;
         }
      }
      ...
      {
         var _loc2_:VG = this.collectVG(param1);
         this.colorizeVG(_loc2_);
         return _loc2_;
      }
      ...
      alternativa3d function colorizeVG(param1:VG) : void
      {
         ...
         if(blendMode != "normal")
         {
            ...
            while(_loc6_ != null)
            {
               if(_loc6_.blendMode == "normal")
               {
                  _loc6_.blendMode = blendMode;
               }
               _loc6_ = _loc6_.next;
            }
         }
         if(colorTransform != null)
         {
            ...
            while(_loc6_ != null)
            {
               if(_loc6_.colorTransform != null)
               {
                  _loc2_ = new ColorTransform(colorTransform.redMultiplier,colorTransform.greenMultiplier,colorTransform.blueMultiplier,colorTransform.alphaMultiplier,colorTransform.redOffset,colorTransform.greenOffset,colorTransform.blueOffset,colorTransform.alphaOffset);
                  _loc2_.concat(_loc6_.colorTransform);
                  _loc6_.colorTransform = _loc2_;
               }
               else
               {
                  _loc6_.colorTransform = colorTransform;
               }
               _loc6_ = _loc6_.next;
            }
         }
         if(filters != null)
         {
            ...
            while(_loc6_ != null)
            {
               if(_loc6_.filters != null)
               {
                  _loc3_ = [];
                  _loc7_ = 0;
                  _loc5_ = int(_loc6_.filters.length);
                  _loc4_ = 0;
                  while(_loc4_ < _loc5_)
                  {
                     _loc3_[_loc7_] = _loc6_.filters[_loc4_];
                     _loc7_++;
                     _loc4_++;
                  }
                  _loc5_ = int(filters.length);
                  _loc4_ = 0;
                  while(_loc4_ < _loc5_)
                  {
                     _loc3_[_loc7_] = filters[_loc4_];
                     _loc7_++;
                     _loc4_++;
                  }
                  _loc6_.filters = _loc3_;
               }
               else
               {
                  _loc6_.filters = filters;
               }
               _loc6_ = _loc6_.next;
            }
         }
