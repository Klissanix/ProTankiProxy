package alternativa.engine3d.core
{
   ...
   public class MouseEvent3D extends Event
   {
      ...
      alternativa3d function calculateLocalRay(param1:Number, param2:Number, param3:Object3D, param4:Camera3D) : void
      {
         ...
         var _loc8_:Object3D = param3;
         while(_loc8_._parent != null)
         {
            _loc8_ = _loc8_._parent;
            _loc8_.composeMatrix();
            param3.appendMatrix(_loc8_);
         }
         param3.invertMatrix();
         var _loc9_:Number = this.localOrigin.x;
         var _loc10_:Number = this.localOrigin.y;
         var _loc11_:Number = this.localOrigin.z;
         var _loc6_:Number = this.localDirection.x;
         var _loc5_:Number = this.localDirection.y;
         var _loc7_:Number = this.localDirection.z;
         this.localOrigin.x = param3.ma * _loc9_ + param3.mb * _loc10_ + param3.mc * _loc11_ + param3.md;
         this.localOrigin.y = param3.me * _loc9_ + param3.mf * _loc10_ + param3.mg * _loc11_ + param3.mh;
         this.localOrigin.z = param3.mi * _loc9_ + param3.mj * _loc10_ + param3.mk * _loc11_ + param3.ml;
         this.localDirection.x = param3.ma * _loc6_ + param3.mb * _loc5_ + param3.mc * _loc7_;
         this.localDirection.y = param3.me * _loc6_ + param3.mf * _loc5_ + param3.mg * _loc7_;
         this.localDirection.z = param3.mi * _loc6_ + param3.mj * _loc5_ + param3.mk * _loc7_;
      }
