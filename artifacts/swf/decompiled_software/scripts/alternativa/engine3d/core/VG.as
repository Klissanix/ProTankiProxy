package alternativa.engine3d.core
{
   ...
   public class VG
   {
      ...
      alternativa3d static function create(param1:Object3D, param2:Face, param3:int, param4:int, param5:Boolean, param6:Number = 1, param7:Number = 0, param8:Number = 0, param9:Number = 1, param10:Number = 0, param11:Number = 0) : VG
      {
         ...
         _loc12_.object = param1;
         _loc12_.alpha = param1.alpha;
         _loc12_.blendMode = param1.blendMode;
         _loc12_.colorTransform = param1.colorTransform;
         _loc12_.filters = param1.filters;
         _loc12_.faceStruct = param2;
         _loc12_.sorting = param3;
         _loc12_.debug = param4;
         if(param5)
         {
            _loc12_.viewAligned = true;
            _loc12_.tma = param6;
            _loc12_.tmb = param7;
            _loc12_.tmc = param8;
            _loc12_.tmd = param9;
            _loc12_.tmtx = param10;
            _loc12_.tmty = param11;
         }
         return _loc12_;
      }
      ...
      alternativa3d function split(param1:Camera3D, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number) : void
      {
         ...
         if(_loc8_.processNegative != null)
         {
            ...
            _loc7_.alpha = this.alpha;
            _loc7_.blendMode = this.blendMode;
            _loc7_.colorTransform = this.colorTransform;
            _loc7_.filters = this.filters;
            ...
            if(this.viewAligned)
            {
               ...
               _loc7_.tmc = this.tmc;
               _loc7_.tmd = this.tmd;
               _loc7_.tmtx = this.tmtx;
               _loc7_.tmty = this.tmty;
            }
      ...
      alternativa3d function draw(param1:Camera3D, param2:Canvas, param3:Number, param4:Object3D) : void
      {
         ...
         if(this.space == 1)
         {
            this.transformStruct(this.faceStruct,++this.object.transformId,param4.ma,param4.mb,param4.mc,param4.md,param4.me,param4.mf,param4.mg,param4.mh,param4.mi,param4.mj,param4.mk,param4.ml);
         }
         if(this.viewAligned)
         {
            _loc8_ = this.faceStruct;
            if(this.debug > 0)
            {
               _loc6_ = param2.getChildCanvas(true,false);
               if(this.debug & 0x10)
               {
                  Debug.drawEdges(param1,_loc6_,_loc8_,this.space != 2 ? 16777215 : 16750848);
               }
               if(this.debug & 8)
               {
                  if(this.space == 1)
                  {
                     Debug.drawBounds(param1,_loc6_,param4,this.boundMinX,this.boundMinY,this.boundMinZ,this.boundMaxX,this.boundMaxY,this.boundMaxZ,10092288);
                  }
               }
            }
            _loc6_ = param2.getChildCanvas(true,false,this.object,this.alpha,this.blendMode,this.colorTransform,this.filters);
            _loc8_.material.drawViewAligned(param1,_loc6_,_loc8_,this.object.ml,this.tma,this.tmb,this.tmc,this.tmd,this.tmtx,this.tmty);
         }
         else
         {
            switch(this.sorting)
            {
               case 0:
                  ...
                  break;
               case 1:
                  _loc8_ = this.faceStruct.processNext != null ? param1.sortByAverageZ(this.faceStruct) : this.faceStruct;
                  break;
               case 2:
                  _loc8_ = this.faceStruct.processNext != null ? param1.sortByDynamicBSP(this.faceStruct,param3) : this.faceStruct;
                  break;
               case 3:
                  _loc8_ = this.d1dfe181(this.faceStruct);
            }
            if(this.debug > 0)
            {
               _loc6_ = param2.getChildCanvas(true,false);
               if(this.debug & 0x10)
               {
                  Debug.drawEdges(param1,_loc6_,_loc8_,16777215);
               }
               if(this.debug & 8)
               {
                  if(this.space == 1)
                  ...
                  {
                     Debug.drawBounds(param1,_loc6_,this.object,this.boundMinX,this.boundMinY,this.boundMinZ,this.boundMaxX,this.boundMaxY,this.boundMaxZ,16750848);
                  }
               }
            }
            _loc6_ = param2.getChildCanvas(true,false,this.object,this.alpha,this.blendMode,this.colorTransform,this.filters);
            ...
            while(_loc7_ != null)
            {
               ...
               if(_loc5_ == null || _loc5_.material != _loc8_.material)
               {
                  _loc7_.processNext = null;
                  if(_loc8_.material != null)
                  {
                     _loc8_.material.draw(param1,_loc6_,_loc8_,this.object.ml);
                  }
                  else
                  {
                     while(_loc8_ != null)
                     {
                        _loc7_ = _loc8_.processNext;
