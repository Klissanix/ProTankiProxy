package alternativa.engine3d.objects
{
   ...
   public class BSP extends Object3D
   {
      ...
      override public function calculateResolution(param1:int, param2:int, param3:int = 1, param4:Matrix3D = null) : Number
      {
         ...
         var _loc20_:int = 0;
         var _loc10_:int = 0;
         var _loc22_:int = int(this.faces.length);
         if(param4 != null)
         {
            _loc23_ = new Object3D();
            _loc23_.matrix = param4;
         ...
         {
            _loc15_ = this.faces[_loc10_];
            _loc11_ = _loc15_.wrapper;
            while(_loc11_ != null)
            {
               _loc5_ = _loc11_.vertex;
               _loc7_ = _loc11_.next != null ? _loc11_.next.vertex : _loc15_.wrapper.vertex;
               _loc8_ = _loc23_ != null ? _loc23_.ma * (_loc7_.x - _loc5_.x) + _loc23_.mb * (_loc7_.y - _loc5_.y) + _loc23_.mc * (_loc7_.z - _loc5_.z) : _loc7_.x - _loc5_.x;
               _loc14_ = _loc23_ != null ? _loc23_.me * (_loc7_.x - _loc5_.x) + _loc23_.mf * (_loc7_.y - _loc5_.y) + _loc23_.mg * (_loc7_.z - _loc5_.z) : _loc7_.y - _loc5_.y;
               _loc16_ = _loc23_ != null ? _loc23_.mi * (_loc7_.x - _loc5_.x) + _loc23_.mj * (_loc7_.y - _loc5_.y) + _loc23_.mk * (_loc7_.z - _loc5_.z) : _loc7_.z - _loc5_.z;
               _loc18_ = (_loc7_.u - _loc5_.u) * param1;
               _loc13_ = (_loc7_.v - _loc5_.v) * param2;
               _loc19_ = _loc8_ * _loc8_ + _loc14_ * _loc14_ + _loc16_ * _loc16_;
               _loc6_ = _loc18_ * _loc18_ + _loc13_ * _loc13_;
               if(_loc19_ > 0.001 && _loc6_ > 0.001)
               {
                  _loc21_ = Math.sqrt(_loc19_ / _loc6_);
                  if(_loc21_ < _loc17_)
                  {
                     _loc17_ = _loc21_;
                  }
         ...
         return param3 < 2 ? _loc12_ / _loc20_ : (param3 == 2 ? _loc17_ : _loc9_);
      }
      ...
      override alternativa3d function draw(param1:Camera3D, param2:Canvas) : void
      {
         ...
         if(transformId > 500000000)
         {
            ...
            while(_loc7_ != null)
            {
               _loc7_.transformId = 0;
               _loc7_ = _loc7_.next;
            }
         }
         transformId = transformId + 1;
         calculateInverseMatrix();
         var _loc8_:Face = this.d1dfe181(this.root);
         if(_loc8_ == null)
         {
            return;
         }
         if(culling > 0)
         {
            if(this.clipping == 1)
            {
               _loc8_ = param1.cull(_loc8_,culling);
            }
            else
            {
               _loc8_ = param1.clip(_loc8_,culling);
            }
            if(_loc8_ == null)
            {
               return;
         ...
         if(param1.debug && (_loc6_ = param1.checkInDebug(this)) > 0)
         {
            ...
            if(_loc6_ & 0x10)
            {
               Debug.drawEdges(param1,_loc4_,_loc8_,16777215);
            }
            if(_loc6_ & 8)
            {
         ...
         _loc4_ = param2.getChildCanvas(true,false,this,alpha,blendMode,colorTransform,filters);
         var _loc5_:Face = _loc8_;
         while(_loc5_ != null)
         {
            _loc3_ = _loc5_.processNext;
            if(_loc3_ == null || _loc3_.material != _loc8_.material)
            {
               _loc5_.processNext = null;
               if(_loc8_.material != null)
               {
                  _loc8_.material.draw(param1,_loc4_,_loc8_,ml);
               }
               else
               {
                  while(_loc8_ != null)
                  {
                     _loc5_ = _loc8_.processNext;
      ...
      override alternativa3d function getVG(param1:Camera3D) : VG
      {
         ...
         transformId = transformId + 1;
         calculateInverseMatrix();
         var _loc3_:Face = this.b1b2218c(this.root,culling,param1);
         if(_loc3_ != null)
         {
            return VG.create(this,_loc3_,3,param1.debug ? param1.checkInDebug(this) : 0,false);
         }
         return null;
      }
