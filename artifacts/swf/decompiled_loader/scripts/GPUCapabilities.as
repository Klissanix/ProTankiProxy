package
{
   ...
   public class GPUCapabilities extends EventDispatcher
   {
      ...
      private function getContext3D() : void
      {
         ...
         _loc1_.addEventListener("error",this.onContext3DCreateError);
      ...
      {
         var _loc3_:Object = this.getStage3D();
         var _loc1_:Object = _loc3_.context3D;
         var _loc2_:String = _loc1_.driverInfo;
         _gpuEnabled = _loc2_.toLowerCase().indexOf("software") == -1;
         _loc1_.dispose();
      }
      ...
      private function removeListeners() : void
      {
         ...
         _loc1_.removeEventListener("error",this.onContext3DCreateError);
      }
